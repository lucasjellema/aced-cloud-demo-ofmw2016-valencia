...
public class SensorLogger implements DataPublisher {
   
    private static final Logger logger = Logger.getLogger("soaring.clouds.SensorLogger");
    public SensorLogger () {
