Instead of merging directly into a table, I decided to use a package to call out to. The package will do an insert - or an update of the total number of votes
