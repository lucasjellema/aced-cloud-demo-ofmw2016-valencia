...
oj.__registerWidget('oj.ojRowExpander', $['oj']['baseComponent'],
{
    ...
    getNodeBySubId: function(locator)
    {
        ...
        subId = locator['subId'];
        if (subId === 'oj-rowexpander-icon' && this.icon != null)
        {
    ...
    getSubIdByNode: function(node)
    {
        ...
        {
            return {subId: 'oj-rowexpander-icon'};
        }
        return null;
    },
    ...
    /**
     * <p>Sub-ID for the ojRowExpander component's icon.  See the <a href="#getNodeBySubId">getNodeBySubId</a> 
     * method for details.</p>
     * 
     * @ojsubid
     * @member
     * @name oj-rowexpander-icon
     * @memberof oj.ojRowExpander
     * @instance
     * 
     * @example <caption>Get the icon from the row expander component:</caption>
     * var node = $( ".selector" ).ojRowExpander( "getNodeBySubId", {'subId': 'oj-rowexpander-icon'} );
     */    
});
