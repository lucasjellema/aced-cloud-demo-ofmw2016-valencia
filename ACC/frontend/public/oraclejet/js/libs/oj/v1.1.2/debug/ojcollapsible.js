...
(function ()
{
  ...
  oj.__registerWidget("oj.ojCollapsible", $['oj']['baseComponent'], 
  {
    ...
    _ComponentCreate : function ()
    {
      ...
      //Bug 20028454 - collapsible shouldn't implement _init()
...
//TODO: ignore disabled until disabled propagation is supported
      if (key === "disabled")
      {
        ...
        //Bug 19707333 - a collapsible contained within a disabled collapsible appears disabled
        return;
      }
      ...
      if (this._initialRender || !event.isDefaultPrevented())
      {
        ...
        if (this._initialRender) {
          ...
          if (isExpanded)
          {
            ...
            //Bug 19720502 - ojcollapsible needs to call oj.components.subtreeshown()/subtreehidden()
