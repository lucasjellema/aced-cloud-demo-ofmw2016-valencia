...
define(["ojs/ojcore", "jquery", "hammerjs", "ojs/ojjquery-hammer", "ojs/ojcomponentcore", "ojs/ojvalidation", "ojs/ojpopup"], function($oj$$4$$, $$$$4$$, $Hammer$$1$$) {
  ...
  $oj$$4$$.$__registerWidget$("oj.editableValue", $$$$4$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{disabled:!1, displayOptions:void 0, help:{definition:null, source:null}, messagesCustom:void 0, messagesHidden:void 0, messagesShown:void 0, required:void 0, title:void 0, validators:void 0, value:void 0}, getNodeBySubId:function($locator$$4$$) {
    ...
    var $msgs$$ = this.options.messagesHidden, $msg$$4$$, $mutated$$ = !1, $i$$93$$, $clonedMsgs$$ = [];
    for ($i$$93$$ = 0;$i$$93$$ < $msgs$$.length;$i$$93$$++) {
      $mutated$$ = !0, $msg$$4$$ = $msgs$$[$i$$93$$], $msg$$4$$ instanceof $oj$$4$$.$ComponentMessage$ && $msg$$4$$.$_forceDisplayToShown$(), $clonedMsgs$$.push($msg$$4$$.clone());
    }
    ...
    if (!this.$_allValidators$) {
      var $allValidators$$ = [], $validatorsOption$$ = this.options.validators, $vOptions_valType_validator$$, $isValidatorInstance$$ = !0, $implicitValidatorMap_vType$$ = this.$_GetImplicitValidators$(), $implicitValidators_normalizedValidators$$ = [], $len$$5_vTypeStr$$, $i$$94_keys$$6$$;
      $i$$94_keys$$6$$ = Object.keys($implicitValidatorMap_vType$$);
      $len$$5_vTypeStr$$ = $i$$94_keys$$6$$.length;
      if (0 < $len$$5_vTypeStr$$) {
        for (var $idx$$1$$ = 0;$idx$$1$$ < $len$$5_vTypeStr$$;$idx$$1$$++) {
          $vOptions_valType_validator$$ = $i$$94_keys$$6$$[$idx$$1$$], $implicitValidators_normalizedValidators$$.push($implicitValidatorMap_vType$$[$vOptions_valType_validator$$]);
        }
        $allValidators$$ = $allValidators$$.concat($implicitValidators_normalizedValidators$$);
      }
      if ($validatorsOption$$) {
        $implicitValidators_normalizedValidators$$ = [];
        for ($i$$94_keys$$6$$ = 0;$i$$94_keys$$6$$ < $validatorsOption$$.length;$i$$94_keys$$6$$++) {
          $vOptions_valType_validator$$ = $validatorsOption$$[$i$$94_keys$$6$$], "object" === typeof $vOptions_valType_validator$$ ? ($vOptions_valType_validator$$.validate && "function" === typeof $vOptions_valType_validator$$.validate || ($isValidatorInstance$$ = !1), $isValidatorInstance$$ || ($len$$5_vTypeStr$$ = $vOptions_valType_validator$$.type) && "string" === typeof $len$$5_vTypeStr$$ && (($implicitValidatorMap_vType$$ = $oj$$4$$.$Validation$.$validatorFactory$($len$$5_vTypeStr$$)) ? ($vOptions_valType_validator$$ = 
  ...
  }, $_HandleChangeEvent$:function($event$$36$$) {
    var $submittedValue$$ = this.$_GetDisplayValue$();
    this.$_SetValue$($submittedValue$$, $event$$36$$);
  }, $_SetRawValue$:function($event$$37$$, $val$$20$$) {
    var $flags$$11$$ = {};
    $flags$$11$$._context = {originalEvent:$event$$37$$, $writeback$:!0, $internalSet$:!0};
  ...
  }, $_SetValue$:function($newValue_parsed$$, $event$$38$$, $options$$124$$) {
    ...
    if ($doValueChangeCheck$$ && $newValue_parsed$$ === this.$_oj_lastElementValue$) {
      ...
      if ($newValue_parsed$$ = this.$_Validate$($newValue_parsed$$, $event$$38$$, $options$$124$$), void 0 !== $newValue_parsed$$ && this.isValid()) {
        return this.$_updateValueOption$($newValue_parsed$$, $event$$38$$, $options$$124$$ && $options$$124$$.$validationContext$), !0;
      }
    }
    return!1;
  }, $_Validate$:function($newValue$$1$$, $event$$39$$, $doNotClearMessages$$1_options$$125$$) {
    ...
    if (void 0 === $newValue$$1$$) {
      ...
      if (this.$_CanSetValue$()) {
        $doNotClearMessages$$1_options$$125$$ || this.$_clearAllMessages$($event$$39$$);
        this.$_setLastSubmittedValue$($newValue$$1$$);
        try {
          return this.$_runNormalValidation$($newValue$$1$$, $mode$$11$$, $context$$36$$, $event$$39$$);
        } catch ($e$$30$$) {
        }
      } else {
    ...
    return "";
  }, $_MESSAGING_CONTENT_UPDATE_TYPE$:{$ALL$:1, $VALIDITY_STATE$:2, $CONVERTER_HINT$:3, $VALIDATOR_HINTS$:4, $TITLE$:5}, $_OPTION_TO_CSS_MAPPING$:{disabled:"oj-disabled", required:"oj-required"}, $_clearAllMessages$:function($event$$40$$, $doNotSetOption$$) {
    $doNotSetOption$$ ? (this.options.messagesHidden = [], this.options.messagesShown = [], this.options.messagesCustom = []) : (this.$_clearMessages$("messagesHidden", $event$$40$$), this.$_clearMessages$("messagesShown", $event$$40$$), this.$_clearMessages$("messagesCustom", $event$$40$$));
    ...
    for (var $i$$95$$ = $beforeLen$$ - 1;0 <= $i$$95$$;$i$$95$$--) {
      $msg$$5$$ = $shownMsgs$$[$i$$95$$], $msg$$5$$ instanceof $oj$$4$$.$ComponentMessage$ && $shownMsgs$$.splice($i$$95$$, 1);
    }
    $shownMsgs$$.length !== $beforeLen$$ && this.$_setMessagesOption$("messagesShown", $shownMsgs$$, null, !0);
  }, $_setMessagesOption$:function($key$$35$$, $value$$83$$, $event$$41$$, $changed$$1$$) {
    var $flags$$12$$ = {}, $bothEmpty$$ = 0 === $value$$83$$.length && 0 === this.options[$key$$35$$].length;
    if ($changed$$1$$ || !$bothEmpty$$) {
      $flags$$12$$._context = {originalEvent:$event$$41$$, $writeback$:!0, $internalSet$:!0}, $flags$$12$$.changed = $changed$$1$$ || !$bothEmpty$$, this.$_resetValid$(), this.option($key$$35$$, $value$$83$$, $flags$$12$$), this.$_updateMessagingContent$();
    }
  }, $_clearMessages$:function($option$$7$$, $event$$42$$) {
    this.$_setMessagesOption$($option$$7$$, [], $event$$42$$);
  }, $_cloneMessagesBeforeSet$:function($value$$84$$) {
    var $msg$$6_val$$21$$, $msgsClone$$ = [], $i$$96$$;
    if ($value$$84$$ && 0 < $value$$84$$.length) {
      for ($i$$96$$ = 0;$i$$96$$ < $value$$84$$.length;$i$$96$$++) {
        $msg$$6_val$$21$$ = $value$$84$$[$i$$96$$], $msg$$6_val$$21$$ instanceof $oj$$4$$.$Message$ ? $msgsClone$$.push($msg$$6_val$$21$$.clone()) : ($msg$$6_val$$21$$ = new $oj$$4$$.$Message$($msg$$6_val$$21$$.summary, $msg$$6_val$$21$$.detail, $msg$$6_val$$21$$.severity), $msg$$6_val$$21$$ = Object.freeze ? Object.freeze($msg$$6_val$$21$$) : $msg$$6_val$$21$$, $msgsClone$$.push($msg$$6_val$$21$$));
      }
    }
    return $msgsClone$$;
    ...
    for (var $shown$$ = this.options.messagesShown, $msg$$7$$, $compMsgs$$, $i$$97$$ = 0;$i$$97$$ < $shown$$.length;$i$$97$$++) {
      $msg$$7$$ = $shown$$[$i$$97$$], $msg$$7$$ instanceof $oj$$4$$.$ComponentMessage$ && $msg$$7$$.$_isMessageAddedByComponent$() && ($compMsgs$$ = $compMsgs$$ || [], $compMsgs$$.push($msg$$7$$));
    }
    ...
    var $customMsgs$$ = this.options.messagesCustom, $shownMsgs$$1$$ = [], $msg$$8$$, $i$$98$$, $previousShown$$ = this.options.messagesShown, $context$$37$$ = $flags$$13$$ ? $flags$$13$$._context : null;
    for ($i$$98$$ = 0;$i$$98$$ < $previousShown$$.length;$i$$98$$++) {
      $msg$$8$$ = $previousShown$$[$i$$98$$], $msg$$8$$ instanceof $oj$$4$$.$ComponentMessage$ && $msg$$8$$.$_isMessageAddedByComponent$() && $shownMsgs$$1$$.push($msg$$8$$);
    }
    for ($i$$98$$ = 0;$i$$98$$ < $customMsgs$$.length;$i$$98$$++) {
      $shownMsgs$$1$$.push($customMsgs$$[$i$$98$$]);
    }
  ...
  }, $_updateMessagesOption$:function($option$$8$$, $newMsgs$$, $event$$43$$) {
    var $len$$6$$, $i$$99$$, $msgs$$1$$;
    if ("object" === typeof $newMsgs$$ && Array.isArray($newMsgs$$)) {
      for ($msgs$$1$$ = this.options[$option$$8$$], $len$$6$$ = $newMsgs$$.length, $i$$99$$ = 0;$i$$99$$ < $len$$6$$;$i$$99$$++) {
        $msgs$$1$$.push($newMsgs$$[$i$$99$$]);
      }
    }
    this.$_setMessagesOption$($option$$8$$, $msgs$$1$$, $event$$43$$, !0);
  }, $_updateMessagingContent$:function() {
    this.$_getComponentMessaging$().update(this.$_getMessagingContent$());
  }, $_updateValueOption$:function($newValue$$2$$, $event$$44$$, $validationContext$$) {
    var $context$$39$$ = {};
    $event$$44$$ && ($context$$39$$.originalEvent = $event$$44$$);
    ...
    for ($i$$100$$ = 0;$i$$100$$ < $allValidators$$1$$.length;$i$$100$$++) {
      $vHint_validator$$1$$ = $allValidators$$1$$[$i$$100$$], "object" === typeof $vHint_validator$$1$$ && $vHint_validator$$1$$.getHint && "function" === typeof $vHint_validator$$1$$.getHint && ($vHint_validator$$1$$ = $vHint_validator$$1$$.getHint()) && $validatorHints$$.push($vHint_validator$$1$$);
    }
    ...
    $$$$4$$.each($previousMsgs$$, function($i$$101$$, $pMsg$$) {
    ...
    $e$$31$$ instanceof $oj$$4$$.$ConverterError$ || $e$$31$$ instanceof $oj$$4$$.$ValidatorError$ ? ($detail$$7_ojmessage$$ = $e$$31$$.$getMessage$(), $oj$$4$$.$Assert$.$assertPrototype$($detail$$7_ojmessage$$, $oj$$4$$.$Message$), $severity$$5$$ = $detail$$7_ojmessage$$.severity, $summary$$4$$ = $detail$$7_ojmessage$$.summary, $detail$$7_ojmessage$$ = $detail$$7_ojmessage$$.detail) : ($severity$$5$$ = $oj$$4$$.$Message$.$SEVERITY_LEVEL$.ERROR, $summary$$4$$ = $oj$$4$$.$Translations$.$getTranslatedString$("oj-message.error"), 
    $detail$$7_ojmessage$$ = $e$$31$$.message || $oj$$4$$.$Translations$.$getTranslatedString$("oj-converter.detail"));
    $msgs$$4$$.push({summary:$summary$$4$$, detail:$detail$$7_ojmessage$$, severity:$severity$$5$$});
  }, $_processValidationErrors$:function($e$$32_msg$$10$$, $context$$40_i$$102$$, $display$$) {
    var $options$$126$$ = {}, $componentMsgs$$ = [], $msgs$$5$$ = $e$$32_msg$$10$$.$_messages$ || [];
    $options$$126$$.context = $context$$40_i$$102$$ || 0;
    ...
    for ($context$$40_i$$102$$ = 0;$context$$40_i$$102$$ < $msgs$$5$$.length;$context$$40_i$$102$$++) {
      $e$$32_msg$$10$$ = $msgs$$5$$[$context$$40_i$$102$$], $componentMsgs$$.push(this.$_createComponentMessage$($e$$32_msg$$10$$.summary, $e$$32_msg$$10$$.detail, $e$$32_msg$$10$$.severity, $options$$126$$));
    }
  ...
  }, $_runNormalValidation$:function($newMsgs$$2_value$$91$$, $mode$$12$$, $context$$42$$, $event$$45$$) {
    ...
    try {
      ...
      throw $newMsgs$$2_value$$91$$ = this.$_processValidationErrors$($ve$$1$$, $context$$42$$), this.$_updateMessagesOption$("messagesShown", $newMsgs$$2_value$$91$$, $event$$45$$), $ve$$1$$;
    }
    return $newValue$$4$$;
  ...
  }, $_updateElementDisplayValue$:function($modelValue$$1$$, $event$$46$$) {
    ...
    try {
      ...
      $newMsgs$$3$$ = this.$_processValidationErrors$($e$$33$$), this.$_updateMessagesOption$("messagesShown", $newMsgs$$3$$, $event$$46$$);
    }
    ...
    this.$_SetRawValue$(null, $actualDisplayValue_displayValue$$1$$);
    ...
    var $allValidators$$3_ve$$2$$ = this.$_GetAllValidators$(), $validator$$2$$, $i$$103$$, $valMsgs$$ = [];
    if (this.$_IsRequired$()) {
    ...
    if (!$requiredOnly$$) {
      for ($i$$103$$ = 0;$i$$103$$ < $allValidators$$3_ve$$2$$.length;$i$$103$$++) {
        if ($validator$$2$$ = $allValidators$$3_ve$$2$$[$i$$103$$], "object" === typeof $validator$$2$$) {
  ...
  $oj$$4$$.$EditableValueUtils$.$getAttributeValue$ = function $$oj$$4$$$$EditableValueUtils$$$getAttributeValue$$($element$$33$$, $attribute$$2$$) {
    var $attrVal_result$$5$$, $propVal$$, $returnVal$$ = {};
    if ($element$$33$$ && $attribute$$2$$) {
      switch($attribute$$2$$) {
        case "disabled":
          $attrVal_result$$5$$ = void 0 !== $element$$33$$.attr("disabled") ? !!$element$$33$$.prop("disabled") : void 0;
          break;
        case "pattern":
          $attrVal_result$$5$$ = $element$$33$$.prop("pattern") || void 0;
          break;
        case "placeholder":
          $attrVal_result$$5$$ = $element$$33$$.prop("placeholder") || void 0;
          break;
        case "readonly":
          $attrVal_result$$5$$ = void 0 !== $element$$33$$.attr("readonly") ? !!$element$$33$$.prop("readonly") : void 0;
          break;
        case "required":
          $attrVal_result$$5$$ = $element$$33$$.attr("required");
          $propVal$$ = $element$$33$$.prop("required");
          $attrVal_result$$5$$ = void 0 !== $attrVal_result$$5$$ ? void 0 !== $propVal$$ ? !!$propVal$$ : !!$attrVal_result$$5$$ : void 0;
          break;
        case "title":
          $attrVal_result$$5$$ = void 0 !== $element$$33$$.attr("title") ? $element$$33$$.prop("title") : void 0;
          break;
        case "value":
          $attrVal_result$$5$$ = $element$$33$$.val() || void 0;
          break;
        default:
          $attrVal_result$$5$$ = $element$$33$$.attr($attribute$$2$$) || void 0;
      }
    }
  ...
  $oj$$4$$.$EditableValueUtils$.$initializeOptionsFromDom$ = function $$oj$$4$$$$EditableValueUtils$$$initializeOptionsFromDom$$($props$$5$$, $constructorOptions$$5$$, $comp$$1$$, $postprocessCallback$$) {
    for (var $initializedOptions$$ = {}, $i$$104$$ = 0;$i$$104$$ < $props$$5$$.length;$i$$104$$++) {
      var $finalValue_prop$$53$$, $attribute$$3_result$$6$$;
      $finalValue_prop$$53$$ = $props$$5$$[$i$$104$$];
      $attribute$$3_result$$6$$ = $finalValue_prop$$53$$.$attribute$;
      var $option$$10$$ = $finalValue_prop$$53$$.option || $attribute$$3_result$$6$$, $coerceDomValue_valueToValidate$$ = $finalValue_prop$$53$$.$coerceDomValue$, $validateOption$$ = $finalValue_prop$$53$$.$validateOption$, $element$$34$$ = $comp$$1$$.element, $previousValue$$ = $comp$$1$$.options[$option$$10$$];
      void 0 === $constructorOptions$$5$$[$option$$10$$] && ($previousValue$$ = $comp$$1$$.options[$option$$10$$], $attribute$$3_result$$6$$ = $oj$$4$$.$EditableValueUtils$.$getAttributeValue$($element$$34$$, $attribute$$3_result$$6$$), $attribute$$3_result$$6$$.$fromDom$ ? ($finalValue_prop$$53$$ = $attribute$$3_result$$6$$.value, $coerceDomValue_valueToValidate$$ && ("boolean" === typeof $coerceDomValue_valueToValidate$$ ? $finalValue_prop$$53$$ = $oj$$4$$.$EditableValueUtils$.$coerceDomValueForOption$($option$$10$$, 
  ...
  (function() {
    $oj$$4$$.$__registerWidget$("oj._ojLabel", $$$$4$$.oj.baseComponent, {version:"1.0.0", defaultElement:"\x3clabel\x3e", widgetEventPrefix:"oj", options:{ariaRequiredUnsupported:!1, describedById:null, help:{definition:null, source:null}, required:!1, rootAttributes:null}, $_BUNDLE_KEY$:{$_TOOLTIP_HELP$:"tooltipHelp", $_TOOLTIP_REQUIRED$:"tooltipRequired"}, widget:function() {
      ...
      this.$_savedClasses$ = $element$$35$$.attr("class");
      ...
      $requiredOpt$$ && ($ariaRequiredUnsupported$$2_options$$129$$ ? $describedByDom$$.append(this.$_createRequiredIconDomElement$()) : this.element.before(this.$_createRequiredIconDomElement$()));
      ...
      if ($arrayOfClasses_classes$$ && ($arrayOfClasses_classes$$ = $arrayOfClasses_classes$$.split(/\s+/), null != $arrayOfClasses_classes$$)) {
        ...
        for (var $i$$105$$ = 0;$i$$105$$ < $numClasses$$;$i$$105$$++) {
          var $className$$4$$ = $arrayOfClasses_classes$$[$i$$105$$];
      ...
      if (this.$_needsHelpIcon$()) {
        $helpIconAnchor$$ = $$$$4$$("\x3ca tabindex\x3d'0' target\x3d'_blank' class\x3d'oj-label-help-icon-anchor oj-label-help-icon oj-component-icon oj-clickable-icon-nocontext'\x3e\x3c/a\x3e", this.document[0]);
        if ($source$$8$$) {
          try {
            $oj$$4$$.$DomUtils$.$validateURL$($source$$8$$), $helpIconAnchor$$.attr("href", $source$$8$$);
          } catch ($e$$36$$) {
            throw Error($e$$36$$ + ". The source option (" + $source$$8$$ + ") is invalid.");
          }
        }
        $helpDef$$4$$ ? $helpIconAnchor$$.attr("title", $helpDef$$4$$) : $helpIconAnchor$$.attr("title", this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_TOOLTIP_HELP$));
      }
      return $helpIconAnchor$$;
    }, $_attachHelpDefToIconAnchor$:function() {
      var $helpDef$$5_helpDefText_position$$1$$;
      $helpDef$$5_helpDefText_position$$1$$ = this.options.help.definition;
      var $helpIcon$$, $helpDefPopupDiv$$;
      $helpIcon$$ = this.widget().find(".oj-label-help-icon-anchor");
      if (0 != $helpIcon$$.length) {
        $helpDef$$5_helpDefText_position$$1$$ = $helpDef$$5_helpDefText_position$$1$$ ? $helpDef$$5_helpDefText_position$$1$$ : this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_TOOLTIP_HELP$);
        this.$_helpDefPopupDivId$ ? ($helpDefPopupDiv$$ = $$$$4$$("#" + this.$_helpDefPopupDivId$)) && $helpDefPopupDiv$$.text($helpDef$$5_helpDefText_position$$1$$) : ($helpDefPopupDiv$$ = $$$$4$$("\x3cdiv style\x3d'display:none'\x3e\x3c/div\x3e"), $helpDefPopupDiv$$.uniqueId(), this.$_helpDefPopupDivId$ = $helpDefPopupDiv$$.prop("id"), $helpDefPopupDiv$$.text($helpDef$$5_helpDefText_position$$1$$), $$$$4$$("body").append($helpDefPopupDiv$$));
        ...
        var $self$$38$$ = this;
        this.$_openPopupForHelpDefCallbackListener$ || (this.$_openPopupForHelpDefCallbackListener$ = function $this$$_openPopupForHelpDefCallbackListener$$($event$$48$$) {
          $self$$38$$.$_handleOpenPopupForHelpDef$($event$$48$$, $helpDefPopupDiv$$, $helpIcon$$, !1);
        });
        ...
        $helpDef$$5_helpDefText_position$$1$$ = {my:"start bottom", at:"end top", collision:"flipcenter", of:$helpIcon$$};
        $helpDefPopupDiv$$.ojPopup({position:$helpDef$$5_helpDefText_position$$1$$});
      }
    }, $_handleOpenPopupForHelpDef$:function($event$$49$$, $helpDefPopupDiv$$1$$, $helpIcon$$1$$, $inMouseDown$$1$$) {
      if ("mousedown" === $event$$49$$.type) {
        $inMouseDown$$1$$ = !0;
      } else {
        if ("focusin" === $event$$49$$.type && $inMouseDown$$1$$) {
          $inMouseDown$$1$$ = !1;
        } else {
          if (this.$_bTouchSupported$) {
            if ("press" === $event$$49$$.type) {
              ...
              $helpDefPopupDiv$$1$$.on("ojclose", function() {
                $widget$$3$$.off($self$$39$$.$_touchEatClickNamespace$);
                $self$$39$$.$_eatClickOnHelpIconListener$ = null;
              });
            } else {
      ...
      var $element$$37$$ = this.element, $helpDef$$6$$ = this.options.help.definition, $title$$8$$;
      $helpDef$$6$$ && ($element$$37$$.addClass("oj-label-help-def"), ($title$$8$$ = $element$$37$$.attr("title")) ? $element$$37$$.attr("title", $title$$8$$ + " " + $helpDef$$6$$) : $element$$37$$.attr("title", $helpDef$$6$$));
  ...
  $oj$$4$$.$PopupMessagingStrategy$.prototype.$_popupOpenCallback$ = function $$oj$$4$$$$PopupMessagingStrategy$$$$_popupOpenCallback$$($event$$51$$) {
    var $target$$75$$ = $$$$4$$($event$$51$$.target), $self$$40$$ = this;
    window.setTimeout(function() {
      $oj$$4$$.Components.$isComponentInitialized$($target$$75$$) ? $target$$75$$.ojPopup("option", "autoDismiss", "focusLoss") : delete $self$$40$$.$$messagingContentRoot$;
    }, 10);
  };
  $oj$$4$$.$PopupMessagingStrategy$.prototype.$_popupCloseCallback$ = function $$oj$$4$$$$PopupMessagingStrategy$$$$_popupCloseCallback$$($event$$52_target$$76$$) {
    $event$$52_target$$76$$ = $$$$4$$($event$$52_target$$76$$.target);
    $oj$$4$$.Components.$isComponentInitialized$($event$$52_target$$76$$) && ($event$$52_target$$76$$.ojPopup("option", "autoDismiss", "none"), $event$$52_target$$76$$.ojPopup("option", "open", null), $event$$52_target$$76$$.ojPopup("option", "close", null));
    delete this.$$messagingContentRoot$;
    $event$$52_target$$76$$.children().remove();
  };
  ...
  $oj$$4$$.$PopupMessagingStrategy$.prototype.$_buildPopupHtml$ = function $$oj$$4$$$$PopupMessagingStrategy$$$$_buildPopupHtml$$() {
    ...
    $$$$4$$.each($nwContent$$, function($i$$106$$, $content$$12$$) {
  ...
  $oj$$4$$.$PopupMessagingStrategy$.prototype.$_buildHintsHtml$ = function $$oj$$4$$$$PopupMessagingStrategy$$$$_buildHintsHtml$$($document$$5$$) {
    var $hint$$2_hints$$3$$ = [], $i$$107$$, $hintsHtml$$ = "";
    ...
    if (this.$ShowValidatorHint$()) {
      for ($hint$$2_hints$$3$$ = this.$GetValidatorHints$(), $i$$107$$ = 0;$i$$107$$ < $hint$$2_hints$$3$$.length;$i$$107$$++) {
        $hintsHtml$$ += $oj$$4$$.$PopupMessagingStrategyUtils$.$buildHintHtml$($document$$5$$, $oj$$4$$.$PopupMessagingStrategy$.$_SELECTOR_FORMCONTROL_HINT_VALIDATOR$, $hint$$2_hints$$3$$[$i$$107$$], !1, $oj$$4$$.$PopupMessagingStrategy$.$_SELECTOR_FORMCONTROL_HINT$);
      }
    }
  ...
  $oj$$4$$.$PopupMessagingStrategyUtils$.$buildHintHtml$ = function $$oj$$4$$$$PopupMessagingStrategyUtils$$$buildHintHtml$$($document$$6$$, $selector$$16$$, $hintText$$, $htmlAllowed$$, $formControlSelectors$$) {
    var $jTitleDom$$;
    $hintText$$ && ($jTitleDom$$ = $$$$4$$($document$$6$$.createElement("div")), $jTitleDom$$.addClass($formControlSelectors$$ + (" " + $selector$$16$$)), $jTitleDom$$.append($oj$$4$$.$PopupMessagingStrategyUtils$.$_getTextDom$($document$$6$$, $hintText$$, $htmlAllowed$$)));
  ...
  $oj$$4$$.$PopupMessagingStrategyUtils$.$buildMessagesHtml$ = function $$oj$$4$$$$PopupMessagingStrategyUtils$$$buildMessagesHtml$$($document$$8$$, $j$$9_messages$$12$$, $maxSeverity$$4_severityStr_summary$$6$$, $renderSeveritySelectors$$2$$) {
    var $content$$14$$ = "", $i$$108$$, $severityLevel$$, $detail$$9_message$$29$$, $messageObj_messagesByType$$, $messagesByTypes$$ = {};
    $messageObj_messagesByType$$ = [];
    for ($i$$108$$ = 0;$i$$108$$ < $j$$9_messages$$12$$.length;$i$$108$$++) {
      $detail$$9_message$$29$$ = $j$$9_messages$$12$$[$i$$108$$], $messageObj_messagesByType$$ = $detail$$9_message$$29$$ instanceof $oj$$4$$.$Message$ ? $detail$$9_message$$29$$ : new $oj$$4$$.$Message$($detail$$9_message$$29$$.summary, $detail$$9_message$$29$$.detail, $detail$$9_message$$29$$.severity), $severityLevel$$ = $oj$$4$$.$Message$.$getSeverityLevel$($messageObj_messagesByType$$.severity), $messagesByTypes$$[$severityLevel$$] || ($messagesByTypes$$[$severityLevel$$] = []), $messagesByTypes$$[$severityLevel$$].push($messageObj_messagesByType$$)
      ;
    }
    for ($i$$108$$ = $maxSeverity$$4_severityStr_summary$$6$$;$i$$108$$ >= $oj$$4$$.$Message$.$SEVERITY_LEVEL$.CONFIRMATION;$i$$108$$--) {
      for ($messageObj_messagesByType$$ = $messagesByTypes$$[$i$$108$$] || [], $j$$9_messages$$12$$ = 0;$j$$9_messages$$12$$ < $messageObj_messagesByType$$.length;$j$$9_messages$$12$$++) {
