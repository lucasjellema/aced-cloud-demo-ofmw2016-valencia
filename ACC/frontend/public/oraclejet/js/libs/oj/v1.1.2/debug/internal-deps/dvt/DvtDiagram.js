...
DvtBaseDiagram.prototype.Init = function(context, callback, callbackObj) {
  ...
  //Bug 16776435: force text to scale linearly
  ...
  this._initAnim;
  //Bug 14813478: flag used to disable the init anim on PPR
...
DvtBaseDiagram.prototype.ApplyLayoutContext = function(layoutContext, animator, bSaveOffset) {
  //Bug 14823204: apply container padding that was set while laying out the container's children
  ...
  if (!this._bCrossedZoomThreshold) {
    for (var li = 0; li < layoutContext.getLinkCount(); li++) {
      ...
      var points = lc.getPoints();
      if (points) {
        //Bug 16211930: turn list of points into path commands compatible for animating
        ...
        if (animator && link.getPoints()) {
          if (translatedPoints.length > 0 && isNaN(translatedPoints[0])) {
            //Bug 16211930: transition between old and new paths
...
DvtBaseDiagramLink.prototype.setPoints = function(points) {
  ...
  //Bug 15867125: need to update the hit detection underlay when animating
  //a link
...
DvtDiagram.prototype._fitContent = function(animator) {
  ...
  if (!this._bRendered) {
    ...
    if (!this.IsResize()) {
      //Bug 16695081: don't override a viewport returned from the layout engine
...
DvtDiagramNode.prototype.getLabelBounds = function() {
  //Bug 14186917: return saved label dimensions, because getting
