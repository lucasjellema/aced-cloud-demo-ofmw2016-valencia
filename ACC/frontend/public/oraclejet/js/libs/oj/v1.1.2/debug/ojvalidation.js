...
oj.DateTimeRangeValidator.prototype.validate = function (value)
{
  var customMessageSummary = this._customMessageSummary,
      ...
      valDate = value ? oj.IntlConverterUtils.isoToLocalDate(value) : null,
      minStr = min && this._converter ? this._converter['format'](oj.IntlConverterUtils.dateToLocalIso(min)) : min,
      maxStr = max && this._converter ? this._converter['format'](oj.IntlConverterUtils.dateToLocalIso(max)) : max;
