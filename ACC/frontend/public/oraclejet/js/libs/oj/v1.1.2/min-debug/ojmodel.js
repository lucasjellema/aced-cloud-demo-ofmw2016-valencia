...
define(["ojs/ojcore", "jquery", "promise"], function($oj$$1$$, $$$$1$$) {
  ...
  $oj$$1$$.$Collection$.prototype.$_cloneInternal$ = function $$oj$$1$$$$Collection$$$$_cloneInternal$$($i$$35_withProperties$$) {
    var $c$$23$$ = new this.constructor, $model$$9$$;
    this.$IsVirtual$() && ($c$$23$$ = this.$_copyFetchProperties$($c$$23$$), $c$$23$$.$_resetModelsToFullLength$());
    $c$$23$$ = this.$_copyProperties$($c$$23$$);
    if ($i$$35_withProperties$$) {
      ...
      for ($i$$35_withProperties$$ = 0;$i$$35_withProperties$$ < $indices$$.length;$i$$35_withProperties$$++) {
        $index$$55$$ = $indices$$[$i$$35_withProperties$$], ($model$$9$$ = this.$_atInternal$($index$$55$$, null, !0, !1)) && $c$$23$$.$_addInternal$($model$$9$$.clone(), {at:$index$$55$$}, !0, !1);
      }
    }
    return $c$$23$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_addInternal$ = function $$oj$$1$$$$Collection$$$$_addInternal$$($m$$2$$, $options$$24$$, $fillIn$$, $deferred$$2$$) {
    function $mergeAttrs$$($collection$$9$$, $modelToTryAndMerge_sortOpt$$inline_347$$, $modelFoundInCollection$$1$$, $newModel$$3$$, $deferred$$4$$) {
      ...
      $needSort$$ && void 0 === $existingModel$$1$$ && !$sort$$ && void 0 === $at$$1$$ && 1 < $collection$$9$$.$_getLength$() && (-1 < $index$$56$$ && ($cid$$ = $collection$$9$$.$_getModel$($index$$56$$).cid), $modelToTryAndMerge_sortOpt$$inline_347$$ = {}, $oj$$1$$.$CollectionUtils$.$copyInto$($modelToTryAndMerge_sortOpt$$inline_347$$, $options$$24$$), $modelToTryAndMerge_sortOpt$$inline_347$$.add = !0, $collection$$9$$.sort($modelToTryAndMerge_sortOpt$$inline_347$$), -1 < $index$$56$$ && ($index$$56$$ = 
      ...
      if (null != $newModel$$4$$) {
        ...
        if ($deferred$$5$$) {
          return $force$$ ? new Promise(function($resolve$$) {
            $mergeAttrs$$($collection$$10$$, $modelToTryAndMerge$$1$$, void 0, $newModel$$4$$, $deferred$$5$$);
            $resolve$$(void 0);
  ...
  $oj$$1$$.$Collection$.prototype.sort = function $$oj$$1$$$$Collection$$$sort$($options$$25$$) {
    ...
    this.$_getModels$().sort(function($a$$83$$, $b$$45$$) {
      return $oj$$1$$.$Collection$.$SortFunc$($a$$83$$, $b$$45$$, $comparator$$, $self$$2$$, $self$$2$$);
    });
  ...
  $oj$$1$$.$Collection$.$SortFunc$ = function $$oj$$1$$$$Collection$$$SortFunc$$($a$$84$$, $b$$46$$, $attrs$$4_comparator$$1$$, $collection$$12$$, $self$$3$$) {
    var $attrs1_keyA$$, $keyB_retVal$$, $i$$39$$;
    if ($$$$1$$.isFunction($attrs$$4_comparator$$1$$)) {
      if (1 === $attrs$$4_comparator$$1$$.length) {
        $attrs1_keyA$$ = $attrs$$4_comparator$$1$$.call($self$$3$$, $a$$84$$);
        $keyB_retVal$$ = $attrs$$4_comparator$$1$$.call($self$$3$$, $b$$46$$);
      ...
      return $attrs$$4_comparator$$1$$.call($self$$3$$, $a$$84$$, $b$$46$$);
    }
    if ($oj$$1$$.$StringUtils$.$isString$($attrs$$4_comparator$$1$$)) {
      for ($attrs$$4_comparator$$1$$ = $attrs$$4_comparator$$1$$.split(","), $i$$39$$ = 0;$i$$39$$ < $attrs$$4_comparator$$1$$.length;$i$$39$$++) {
        if ($attrs1_keyA$$ = $oj$$1$$.$Collection$.$_getKey$($a$$84$$, $attrs$$4_comparator$$1$$[$i$$39$$]), $keyB_retVal$$ = $oj$$1$$.$Collection$.$_getKey$($b$$46$$, $attrs$$4_comparator$$1$$[$i$$39$$]), $keyB_retVal$$ = $oj$$1$$.$Collection$.$_compareKeys$($attrs1_keyA$$, $keyB_retVal$$, $collection$$12$$.sortDirection), 0 !== $keyB_retVal$$) {
          return $keyB_retVal$$;
        }
      }
    }
  ...
  $oj$$1$$.$Collection$.prototype.$sortedIndex$ = function $$oj$$1$$$$Collection$$$$sortedIndex$$($model$$11$$, $comparator$$2$$) {
    ...
    $self$$4$$ = this;
    return $oj$$1$$.$Collection$.$_find$(this.$_getModels$(), $model$$11$$, function($a$$85$$, $b$$47$$) {
      var $attrs1$$1_keyA$$1$$, $attrs2$$1_keyB$$1$$;
      if ($$$$1$$.isFunction($comp$$)) {
        if (1 === $comp$$.length) {
          $attrs1$$1_keyA$$1$$ = $comp$$.call($self$$4$$, $a$$85$$);
          $attrs2$$1_keyB$$1$$ = $comp$$.call($self$$4$$, $b$$47$$);
        ...
        return $comp$$.call($self$$4$$, $a$$85$$, $b$$47$$);
      }
      return $oj$$1$$.$StringUtils$.$isString$($comp$$) ? ($attrs1$$1_keyA$$1$$ = $a$$85$$.get($comp$$), $attrs2$$1_keyB$$1$$ = $b$$47$$.get($comp$$), $oj$$1$$.$Collection$.$_compareKeys$($attrs1$$1_keyA$$1$$, $attrs2$$1_keyB$$1$$, $self$$4$$.sortDirection)) : 0;
    });
  };
  $oj$$1$$.$Object$.$exportPrototypeSymbol$("Collection.prototype.sortedIndex", {$sortedIndex$:$oj$$1$$.$Collection$.prototype.$sortedIndex$});
  $oj$$1$$.$Collection$.$_find$ = function $$oj$$1$$$$Collection$$$_find$$($modelArray$$1$$, $model$$12$$, $comparator$$3$$) {
    function $search$$($min$$, $max$$) {
      var $cid$$1_mid$$, $id$$2$$;
      if ($min$$ > $max$$) {
        return-1;
      }
      $cid$$1_mid$$ = $model$$12$$.$GetCid$();
      $id$$2$$ = $model$$12$$.$GetId$();
      ...
      return-1 === $comparator$$3$$($modelArray$$1$$[$cid$$1_mid$$], $model$$12$$) ? $search$$($min$$ + 1, $cid$$1_mid$$) : 1 === $comparator$$3$$($modelArray$$1$$[$cid$$1_mid$$], $model$$12$$) ? $search$$($cid$$1_mid$$, $max$$ - 1) : $cid$$1_mid$$;
    }
  ...
  $oj$$1$$.$Collection$.prototype.shift = function $$oj$$1$$$$Collection$$$shift$($options$$27$$) {
    var $deferred$$6$$ = this.$_getDeferred$($options$$27$$);
    if (this.$IsVirtual$() || $deferred$$6$$) {
      var $self$$5$$ = this;
      return this.at(0, $options$$27$$).then(function($model$$13$$) {
        return $self$$5$$.$_removeInternal$($model$$13$$, 0, $options$$27$$);
      });
    }
    return this.$_removeInternal$(this.at(0), 0, $options$$27$$);
  };
    ...
    return new Promise(function($allResolve$$1$$, $allReject$$1$$) {
      function $doTask$$1$$($index$$58$$) {
        return new Promise(function($resolve$$2$$, $reject$$2$$) {
          $self$$6$$.$_deferredAt$($index$$58$$, null).then(function($model$$14$$) {
            $array$$12$$.push($model$$14$$);
  ...
  $oj$$1$$.$Collection$.prototype.$_removeInternal$ = function $$oj$$1$$$$Collection$$$$_removeInternal$$($modInfo$$1_model$$16$$, $index$$59$$, $options$$34$$) {
    $options$$34$$ = $options$$34$$ || {};
    $modInfo$$1_model$$16$$ = -1 == $index$$59$$ ? this.$_getInternal$($modInfo$$1_model$$16$$) : $oj$$1$$.$Collection$.$_getModinfo$($index$$59$$, $modInfo$$1_model$$16$$);
    var $silent$$5$$ = $options$$34$$.silent;
    $index$$59$$ = $modInfo$$1_model$$16$$.index;
    if (-1 < $index$$59$$) {
      var $mod$$2$$ = $modInfo$$1_model$$16$$.m;
  ...
  $oj$$1$$.$Collection$.prototype.$_modelEvent$ = function $$oj$$1$$$$Collection$$$$_modelEvent$$($event$$13$$, $model$$17$$, $collection$$13$$, $options$$35$$) {
    $event$$13$$ === $oj$$1$$.$Events$.$EventType$.DESTROY && this.remove($model$$17$$);
    void 0 !== $collection$$13$$ && $collection$$13$$ instanceof $oj$$1$$.$Collection$ && $collection$$13$$ !== this || (Array.prototype.slice.call(arguments), this.$TriggerInternal$($options$$35$$ && $options$$35$$.silent, $event$$13$$, $model$$17$$, $collection$$13$$, $options$$35$$));
  };
  $oj$$1$$.$Collection$.prototype.refresh = function $$oj$$1$$$$Collection$$$refresh$($options$$36$$) {
    ...
    return this.$_addPromise$(function() {
      return new Promise(function($resolve$$3$$, $reject$$3$$) {
        if (!$self$$9$$.$IsVirtual$()) {
          ...
          try {
            ...
            $opt$$6_startIndex$$1$$.success = function $$opt$$6_startIndex$$1$$$success$($collection$$14$$, $response$$, $options$$37$$) {
              $self$$9$$.$TriggerInternal$($silent$$7$$, $oj$$1$$.$Events$.$EventType$.REFRESH, $self$$9$$, $options$$37$$, null);
            ...
            $opt$$6_startIndex$$1$$.error = function $$opt$$6_startIndex$$1$$$error$($xhr$$1$$, $status$$, $error$$3$$) {
              $reject$$3$$($oj$$1$$.$Collection$.$_createRejectionError$($xhr$$1$$, $status$$, $error$$3$$, $self$$9$$, $options$$36$$));
            };
            $self$$9$$.fetch($opt$$6_startIndex$$1$$);
            return;
          } catch ($e$$19$$) {
            if ($e$$19$$ instanceof $oj$$1$$.$URLError$) {
              $self$$9$$.$TriggerInternal$($silent$$7$$, $oj$$1$$.$Events$.$EventType$.REFRESH, $self$$9$$, $options$$36$$, null);
              $resolve$$3$$({collection:$self$$9$$, options:$options$$36$$});
              return;
            }
            throw $e$$19$$;
          }
        ...
        void 0 !== $opt$$6_startIndex$$1$$ && null !== $opt$$6_startIndex$$1$$ ? $self$$9$$.$_setRangeLocalInternal$($opt$$6_startIndex$$1$$, $self$$9$$.$_getFetchSize$($options$$36$$)).then(function($actual$$) {
          $resolve$$3$$($actual$$);
        }) : $resolve$$3$$(void 0);
      });
    });
  ...
  $oj$$1$$.$Collection$.prototype.reset = function $$oj$$1$$$$Collection$$$reset$($data$$33$$, $options$$38$$) {
    ...
    for (var $index$$60_model$$18_retObj$$, $i$$45_silent$$8$$ = 0;$i$$45_silent$$8$$ < this.$_modelIndices$.length;$i$$45_silent$$8$$++) {
      if ($index$$60_model$$18_retObj$$ = this.$_modelIndices$[$i$$45_silent$$8$$], $index$$60_model$$18_retObj$$ = this.$_getModel$($index$$60_model$$18_retObj$$)) {
        this.$_unlistenToModel$($index$$60_model$$18_retObj$$), $index$$60_model$$18_retObj$$.$SetCollection$(null);
      }
    }
    this.$_setModels$([], !0);
    this.$_resetLRU$();
  ...
  $oj$$1$$.$Collection$.prototype.$_atInternal$ = function $$oj$$1$$$$Collection$$$$_atInternal$$($index$$62$$, $options$$40$$, $local$$, $deferred$$10$$) {
    ...
    return 0 > $index$$62$$ || this.$_overUpperLimit$($index$$62$$) ? null : $local$$ || !this.$IsVirtual$() && !$deferred$$10$$ ? this.$_getModel$($index$$62$$) : this.$_addPromise$(function() {
      return this.$_deferredAt$($index$$62$$, $options$$40$$);
    });
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_addPromise$ = function $$oj$$1$$$$Collection$$$$_addPromise$$($promiseTask$$) {
    ...
    this.$_promiseCount$++;
    return this.$_promises$ = this.$_promises$.then($promiseTask$$.bind($self$$10$$)).then(function($arg$$10$$) {
      $self$$10$$.$_promiseCount$--;
      0 === $self$$10$$.$_promiseCount$ && ($self$$10$$.$_promises$ = void 0, $self$$10$$.$TriggerInternal$(!1, $oj$$1$$.$Events$.$EventType$.READY, $self$$10$$, null, null));
      return $arg$$10$$;
    }, function($error$$4$$) {
      $self$$10$$.$_promiseCount$--;
      0 === $self$$10$$.$_promiseCount$ && ($self$$10$$.$_promises$ = void 0);
  ...
  $oj$$1$$.$Collection$.prototype.$_deferredAt$ = function $$oj$$1$$$$Collection$$$$_deferredAt$$($index$$63$$, $options$$41$$) {
    var $self$$11$$ = this, $model$$19$$ = $self$$11$$.$_getModel$($index$$63$$);
    return void 0 === $model$$19$$ ? new Promise(function($resolve$$4$$, $reject$$4$$) {
      var $opts$$1$$ = {};
      $oj$$1$$.$CollectionUtils$.$copyInto$($opts$$1$$, $options$$41$$ || {});
      $opts$$1$$.context = $self$$11$$;
      $opts$$1$$.startIndex = $index$$63$$;
      $opts$$1$$.error = function $$opts$$1$$$error$($xhr$$2$$, $status$$1$$, $error$$5$$) {
        $reject$$4$$($oj$$1$$.$Collection$.$_createRejectionError$($xhr$$2$$, $status$$1$$, $error$$5$$, $self$$11$$, $options$$41$$));
      };
      $opts$$1$$.success = function $$opts$$1$$$success$() {
        $resolve$$4$$($self$$11$$.$_getModel$($index$$63$$));
      };
      $self$$11$$.$_fetchInternal$($opts$$1$$, -1, !1);
  ...
  $oj$$1$$.$Collection$.prototype.$_getLocalInternal$ = function $$oj$$1$$$$Collection$$$$_getLocalInternal$$($id$$5$$) {
    ...
    for (var $foundObj$$ = null, $len$$2$$ = this.$_modelIndices$.length, $model$$20$$, $models$$6$$ = this.$_getModels$(), $index$$65$$, $i$$47$$ = 0;$i$$47$$ < $len$$2$$;$i$$47$$++) {
      if ($index$$65$$ = this.$_modelIndices$[$i$$47$$], $model$$20$$ = $models$$6$$[$index$$65$$], void 0 !== $model$$20$$ && $model$$20$$.$Match$($id$$5$$, $cid$$2$$)) {
        $foundObj$$ = $oj$$1$$.$Collection$.$_getModinfo$($index$$65$$, $model$$20$$);
        break;
      }
    }
  ...
  $oj$$1$$.$Collection$.prototype.$_getInternal$ = function $$oj$$1$$$$Collection$$$$_getInternal$$($id$$6$$, $options$$43$$, $deferred$$12$$, $fillIn$$1$$) {
    ...
    if (this.$IsVirtual$()) {
      ...
      return new Promise(function($resolve$$10$$, $reject$$10$$) {
        ...
        $opts$$2$$.context = $self$$12$$;
        $opts$$2$$.startID = $id$$6$$;
        $opts$$2$$.error = function $$opts$$2$$$error$($xhr$$3$$, $status$$2$$, $error$$6$$) {
          $reject$$10$$($oj$$1$$.$Collection$.$_createRejectionError$($xhr$$3$$, $status$$2$$, $error$$6$$, $self$$12$$, $options$$43$$));
        };
        $opts$$2$$.success = function $$opts$$2$$$success$($collection$$16$$, $response$$2$$) {
          if (null != $response$$2$$) {
            var $index$$inline_350$$ = $self$$12$$.$_getOffset$(), $model$$inline_351$$ = $self$$12$$.$_getModel$($index$$inline_350$$);
            void 0 !== $model$$inline_351$$ && $model$$inline_351$$.$Match$($id$$6$$, $cid$$3$$) ? $resolve$$10$$($oj$$1$$.$Collection$.$_getModinfo$($index$$inline_350$$, $model$$inline_351$$)) : $resolve$$10$$($oj$$1$$.$Collection$.$_getModinfo$(-1, void 0));
          } else {
            $resolve$$10$$($oj$$1$$.$Collection$.$_getModinfo$(-1, void 0));
          }
        };
        $self$$12$$.$_fetchInternal$($opts$$2$$, -1, $fillIn$$1$$);
      });
    }
  ...
  $oj$$1$$.$Collection$.$_getModinfo$ = function $$oj$$1$$$$Collection$$$_getModinfo$$($index$$68$$, $model$$22$$) {
    return{index:$index$$68$$, m:$model$$22$$};
  };
  ...
  $oj$$1$$.$Collection$.prototype.$setRangeLocal$ = function $$oj$$1$$$$Collection$$$$setRangeLocal$$($start$$17$$, $count$$13$$) {
    var $self$$13$$ = this;
    return this.$_addPromise$(function() {
      return $self$$13$$.$_setRangeLocalInternal$($start$$17$$, $count$$13$$);
    });
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_setRangeLocalInternal$ = function $$oj$$1$$$$Collection$$$$_setRangeLocalInternal$$($start$$18$$, $count$$14$$) {
    ...
    var $actual$$2$$ = this.$_getLocalRange$($start$$18$$, $count$$14$$), $self$$14$$ = this;
    ...
    return new Promise(function($resolve$$13$$, $reject$$13$$) {
      $self$$14$$.$_setRangeLocalFetch$($start$$18$$, $count$$14$$, -1, {start:$start$$18$$, count:$count$$14$$}, $resolve$$13$$, $reject$$13$$, !0);
    });
  };
  $oj$$1$$.$Collection$.prototype.$_setRangeLocalFetch$ = function $$oj$$1$$$$Collection$$$$_setRangeLocalFetch$$($start$$19$$, $count$$15$$, $actual$$3_placement$$, $original$$2$$, $resolve$$14$$, $reject$$14$$, $fill$$) {
    var $self$$15$$ = this, $limit$$1$$ = $start$$19$$ + $count$$15$$;
    ...
    $newStart_opts$$3$$.error = function $$newStart_opts$$3$$$error$($xhr$$4$$, $status$$3$$, $error$$7$$) {
      $reject$$14$$($oj$$1$$.$Collection$.$_createRejectionError$($xhr$$4$$, $status$$3$$, $error$$7$$, $self$$15$$, null));
    };
    $newStart_opts$$3$$.success = function $$newStart_opts$$3$$$success$() {
      var $actual$$inline_353$$ = $self$$15$$.$_getLocalRange$($original$$2$$.start, $original$$2$$.count);
      if ($fill$$ && $self$$15$$.$_hasTotalResults$() && $actual$$inline_353$$.count < $original$$2$$.count) {
        var $newPlacement$$inline_354$$ = $actual$$inline_353$$.start + $actual$$inline_353$$.count, $newStart$$inline_355$$ = $start$$19$$ + $count$$15$$;
        $newStart$$inline_355$$ < $self$$15$$.totalResults ? $self$$15$$.$_setRangeLocalFetch$($newStart$$inline_355$$, $count$$15$$, $newPlacement$$inline_354$$, $original$$2$$, $resolve$$14$$, $reject$$14$$, $fill$$) : $resolve$$14$$($actual$$inline_353$$);
      } else {
        $resolve$$14$$($actual$$inline_353$$);
      }
    };
    try {
      this.$_fetchInternal$($newStart_opts$$3$$, $actual$$3_placement$$, -1 < $actual$$3_placement$$);
    } catch ($e$$20$$) {
      $e$$20$$ instanceof $oj$$1$$.$URLError$ && ($actual$$3_placement$$ = $self$$15$$.$_getLocalRange$($start$$19$$, $count$$15$$), $resolve$$14$$($actual$$3_placement$$));
    }
  };
  $oj$$1$$.$Collection$.$_createRejectionError$ = function $$oj$$1$$$$Collection$$$_createRejectionError$$($xhr$$5$$, $status$$4$$, $error$$8$$, $collection$$18$$, $err$$1_options$$44$$) {
    var $silent$$9$$ = !1;
    $err$$1_options$$44$$ && $err$$1_options$$44$$.silent && ($silent$$9$$ = $err$$1_options$$44$$.silent);
    $oj$$1$$.$Model$.$_triggerError$($collection$$18$$, $silent$$9$$, $err$$1_options$$44$$, $status$$4$$, $error$$8$$, $xhr$$5$$);
    $err$$1_options$$44$$ = Error($status$$4$$);
    $err$$1_options$$44$$.xhr = $xhr$$5$$;
    $err$$1_options$$44$$.error = $error$$8$$;
    $err$$1_options$$44$$.collection = $collection$$18$$;
    $err$$1_options$$44$$.status = $status$$4$$;
    return $err$$1_options$$44$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_getLocalRange$ = function $$oj$$1$$$$Collection$$$$_getLocalRange$$($start$$23$$, $count$$19$$) {
    if (!this.$IsVirtual$()) {
      if (0 < this.$_getModelsLength$()) {
        if ($start$$23$$ + $count$$19$$ > this.$_getModelsLength$()) {
          var $c$$24_limit$$2$$ = this.$_getModelsLength$() - $start$$23$$;
          return{start:$start$$23$$, count:$c$$24_limit$$2$$, models:this.$_getModelArray$($start$$23$$, $c$$24_limit$$2$$)};
        }
        return{start:$start$$23$$, count:$count$$19$$, models:this.$_getModelArray$($start$$23$$, $count$$19$$)};
      }
      return{start:$start$$23$$, count:0, models:[]};
    }
    $c$$24_limit$$2$$ = this.$_getMaxLength$($start$$23$$, $count$$19$$);
    if (!this.$_hasTotalResults$() && $c$$24_limit$$2$$ < $start$$23$$ + $count$$19$$) {
      return{start:$start$$23$$, count:$c$$24_limit$$2$$ - $start$$23$$, models:this.$_getModelArray$($start$$23$$, $c$$24_limit$$2$$ - $start$$23$$)};
    }
    if (0 === $c$$24_limit$$2$$) {
      return{start:$start$$23$$, count:0, models:[]};
    }
    var $firstMissingModel$$ = this.$_getFirstMissingModel$($start$$23$$, $c$$24_limit$$2$$);
    ...
    $start$$23$$ > $c$$24_limit$$2$$ ? $count$$19$$ = 0 : $start$$23$$ + $count$$19$$ > $c$$24_limit$$2$$ && ($count$$19$$ = $c$$24_limit$$2$$ - $start$$23$$);
    return{start:$start$$23$$, count:$count$$19$$, models:this.$_getModelArray$($start$$23$$, $count$$19$$)};
  };
  ...
  $oj$$1$$.$Collection$.prototype.fetch = function $$oj$$1$$$$Collection$$$fetch$($options$$45$$) {
    return this.$_fetchInternal$($options$$45$$, -1, !1);
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_fetchInternal$ = function $$oj$$1$$$$Collection$$$$_fetchInternal$$($options$$46$$, $placement$$1$$, $fillIn$$2$$) {
    ...
    var $opt$$7$$ = $options$$46$$ || {}, $success$$8$$ = $opt$$7$$.success, $self$$16$$, $errFunc$$ = $opt$$7$$.error;
    $opt$$7$$.set && ($opt$$7$$.$useset$ = $opt$$7$$.set ? !0 : !1);
    void 0 === $opt$$7$$.parse && ($opt$$7$$.parse = !0);
    $self$$16$$ = this;
    $opt$$7$$.error = function $$opt$$7$$$error$($xhr$$6$$, $status$$5$$, $error$$9$$) {
      $oj$$1$$.$Model$.$_triggerError$($self$$16$$, !1, $options$$46$$, $status$$5$$, $error$$9$$, $xhr$$6$$);
      $errFunc$$ && $errFunc$$.call($oj$$1$$.$Model$.$GetContext$($options$$46$$, $self$$16$$), $xhr$$6$$, $status$$5$$, $error$$9$$);
    };
    $opt$$7$$.success = function $$opt$$7$$$success$($response$$5$$) {
      var $data$$34$$;
      try {
        $data$$34$$ = $self$$16$$.parse($response$$5$$, $options$$46$$);
      } catch ($e$$21$$) {
        $oj$$1$$.$Collection$.$_reportError$($self$$16$$, $e$$21$$, $opt$$7$$.error, $options$$46$$);
        return;
      }
      $self$$16$$.$_setPagingReturnValues$($response$$5$$, $options$$46$$, $data$$34$$, $fillIn$$2$$);
      var $dataList$$ = null;
      if ($opt$$7$$.add || $self$$16$$.model) {
        $doReset$$($self$$16$$, $opt$$7$$, $fillIn$$2$$);
        try {
          $manageLRU$$ = !1, -1 === $placement$$1$$ && ($manageLRU$$ = !0, $placement$$1$$ = $self$$16$$.$_getOffset$()), $dataList$$ = $self$$16$$.$_fillInCollectionWithParsedData$($data$$34$$, $placement$$1$$, $manageLRU$$, $opt$$7$$);
        } catch ($e$$22$$) {
          $oj$$1$$.$Collection$.$_reportError$($self$$16$$, $e$$22$$, $opt$$7$$.error, $options$$46$$);
          return;
        }
      } else {
        if (!$fillIn$$2$$) {
          if ($self$$16$$.$IsVirtual$()) {
            ...
            $dataList$$ = $self$$16$$.$_putDataIntoCollection$($data$$34$$, $placement$$1$$, $manageLRU$$);
          } else {
            $opt$$7$$.$useset$ ? $self$$16$$.$_setInternal$($data$$34$$, !1, $opt$$7$$, !1) : $self$$16$$.reset($data$$34$$, {silent:!0});
          }
        }
      }
      $self$$16$$.$IsVirtual$() && $dataList$$ && ($self$$16$$.lastFetchCount = $dataList$$.length);
      $self$$16$$.$TriggerInternal$($opt$$7$$.silent ? !0 : !1, $oj$$1$$.$Events$.$EventType$.SYNC, $self$$16$$, $response$$5$$, $opt$$7$$);
      $success$$8$$ && $success$$8$$.call($oj$$1$$.$Model$.$GetContext$($options$$46$$, $self$$16$$), $self$$16$$, $response$$5$$, $opt$$7$$);
    };
  ...
  $oj$$1$$.$Collection$.$_reportError$ = function $$oj$$1$$$$Collection$$$_reportError$$($collection$$20$$, $e$$23$$, $errorFunc$$, $options$$47$$) {
    $oj$$1$$.$Logger$.error($e$$23$$.toString());
    $errorFunc$$ && $errorFunc$$.call($oj$$1$$.$Model$.$GetContext$($options$$47$$, $collection$$20$$), $collection$$20$$, $e$$23$$, $options$$47$$);
  };
  $oj$$1$$.$Collection$.prototype.$_fetchOnly$ = function $$oj$$1$$$$Collection$$$$_fetchOnly$$($options$$48$$) {
    var $opt$$10$$ = $options$$48$$ || {}, $success$$9$$ = $opt$$10$$.success, $parsedModel$$1$$, $self$$17$$;
    ...
    $opt$$10$$.success = function $$opt$$10$$$success$($response$$6$$) {
      ...
      try {
        $data$$37_i$$53$$ = $self$$17$$.parse($response$$6$$, $options$$48$$);
      } catch ($e$$24$$) {
        $oj$$1$$.$Collection$.$_reportError$($self$$17$$, $e$$24$$, $opt$$10$$.error, $options$$48$$);
        return;
      }
      if ($opt$$10$$.add || $self$$17$$.model) {
        if ($modelInstance$$1$$ = $oj$$1$$.$Collection$.$_createModel$($self$$17$$), $data$$37_i$$53$$) {
          for ($dataList$$3$$ = $data$$37_i$$53$$ instanceof Array ? $data$$37_i$$53$$ : [$data$$37_i$$53$$], $data$$37_i$$53$$ = 0;$data$$37_i$$53$$ < $dataList$$3$$.length;$data$$37_i$$53$$ += 1) {
            if ($modelInstance$$1$$ && $opt$$10$$.parse) {
              try {
                ...
                $oj$$1$$.$Collection$.$_reportError$($self$$17$$, $e$$25$$, $opt$$10$$.error, $options$$48$$);
                return;
              }
            } else {
              $parsedModel$$1$$ = $dataList$$3$$[$data$$37_i$$53$$];
            }
            $fetchedModels$$.push($self$$17$$.$_newModel$($parsedModel$$1$$));
          }
        }
      }
      $self$$17$$.$TriggerInternal$(!1, $oj$$1$$.$Events$.$EventType$.SYNC, $self$$17$$, $response$$6$$, $opt$$10$$);
      $success$$9$$ && $success$$9$$.call($oj$$1$$.$Model$.$GetContext$($options$$48$$, $self$$17$$), $self$$17$$, $fetchedModels$$, $opt$$10$$);
    };
  ...
  $oj$$1$$.$Collection$.prototype.$_fetchCall$ = function $$oj$$1$$$$Collection$$$$_fetchCall$$($opt$$11$$) {
    try {
      ...
      throw $oj$$1$$.$Model$.$_triggerError$(this, !1, $opt$$11$$, null, $e$$26$$, null), $e$$26$$;
    }
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_setPagingReturnValues$ = function $$oj$$1$$$$Collection$$$$_setPagingReturnValues$$($response$$8$$, $options$$50$$, $data$$38$$, $fillIn$$4$$) {
    ...
    this.totalResults = this.$_getReturnProperty$($customObj$$1$$, $response$$8$$, "totalResults", this.totalResults, this.totalResults);
    ...
    $fillIn$$4$$ || (this.totalResults = this.$_adjustTotalResults$(parseInt($oj$$1$$.$Collection$.$_getProp$($customObj$$1$$, $response$$8$$, "totalResults"), 10), this.hasMore, this.offset, parseInt($oj$$1$$.$Collection$.$_getProp$($customObj$$1$$, $response$$8$$, "count"), 10), $data$$38$$ && Array.isArray($data$$38$$) ? $data$$38$$.length : 0));
  ...
  $oj$$1$$.$Collection$.prototype.create = function $$oj$$1$$$$Collection$$$create$($attributes$$, $options$$51$$) {
    ...
    function $doAdd$$1$$($newModel$$7$$, $addOpts$$1$$) {
      if ($options$$51$$.wait) {
        if ($self$$18$$.$IsVirtual$() || $deferred$$13$$) {
          return $self$$18$$.$_addPromise$(function() {
            return Promise.resolve(void 0);
          });
        }
      } else {
        return $self$$18$$.add($newModel$$7$$, $addOpts$$1$$);
      }
    }
    var $self$$18$$ = this;
    $options$$51$$ = $options$$51$$ || {};
    var $deferred$$13$$ = this.$_getDeferred$($options$$51$$), $newModel$$5$$ = this.$_newModel$($attributes$$, $options$$51$$, !1), $callback$$73$$ = $options$$51$$.success, $context$$14$$ = $options$$51$$.context;
    $options$$51$$.context = this;
    $options$$51$$.success = function $$options$$51$$$success$($model$$24$$, $resp$$3$$, $successOpts$$) {
      $successOpts$$.xhr && ($options$$51$$.xhr = $successOpts$$.xhr);
      $options$$51$$.wait && $self$$18$$.add($newModel$$5$$, $options$$51$$);
      $callback$$73$$ && $callback$$73$$.call(null != $context$$14$$ ? $context$$14$$ : $self$$18$$, $model$$24$$, $resp$$3$$, $options$$51$$);
    };
    if (null == $newModel$$5$$) {
      return!1;
    }
    ...
    if ($deferred$$13$$ || this.$IsVirtual$()) {
      return new Promise(function($resolve$$15$$) {
        ...
        $doAdd$$1$$($newModel$$5$$, $addOpts$$).then(function() {
          $options$$51$$.success = function $$options$$51$$$success$($model$$26$$, $resp$$4$$, $successOpts$$1$$) {
            $successOpts$$1$$.xhr && ($options$$51$$.xhr = $successOpts$$1$$.xhr);
            $options$$51$$.wait ? ($self$$18$$.$IsVirtual$() && ($addOpts$$.force = !0), $self$$18$$.add($newModel$$5$$, $addOpts$$).then(function() {
              $callback$$73$$ && $callback$$73$$.call(null != $context$$14$$ ? $context$$14$$ : $self$$18$$, $model$$26$$, $resp$$4$$, $options$$51$$);
              $resolve$$15$$($model$$26$$);
            })) : ($callback$$73$$ && $callback$$73$$.call(null != $context$$14$$ ? $context$$14$$ : $self$$18$$, $model$$26$$, $resp$$4$$, $options$$51$$), $resolve$$15$$($model$$26$$));
          };
          var $model$$25$$ = $doSave$$($newModel$$5$$, $options$$51$$);
          $model$$25$$ || $resolve$$15$$($model$$25$$);
        });
      });
    }
    $addOpts$$.merge = !0;
  ...
  $oj$$1$$.$Collection$.prototype.$_whereInternal$ = function $$oj$$1$$$$Collection$$$$_whereInternal$$($attrs$$6$$, $options$$53$$) {
    ...
    var $deferred$$14$$ = this.$_getDeferred$($options$$53$$), $self$$19$$ = this;
    if (this.$IsVirtual$()) {
      return new Promise(function($resolve$$16$$, $reject$$16$$) {
        $self$$19$$.$_fetchOnly$({query:$attrs$$6$$, all:!0, success:function($collection$$22$$, $fetchedModels$$1$$) {
          $resolve$$16$$($fetchedModels$$1$$);
        }, error:function($xhr$$9$$, $status$$8$$, $error$$10$$) {
          $reject$$16$$($oj$$1$$.$Collection$.$_createRejectionError$($xhr$$9$$, $status$$8$$, $error$$10$$, $self$$19$$, $options$$53$$));
        }});
      });
    }
    var $arr$$17$$ = [], $i$$55$$, $m$$7$$;
  ...
  $oj$$1$$.$Collection$.prototype.$whereToCollection$ = function $$oj$$1$$$$Collection$$$$whereToCollection$$($attrs$$7$$, $options$$55$$) {
    ...
    var $deferred$$15_models$$9_newCollection$$ = this.$_getDeferred$($options$$55$$), $self$$20$$ = this;
    if (this.$IsVirtual$() || $deferred$$15_models$$9_newCollection$$) {
      return this.$_addPromise$(function() {
        return new Promise(function($resolve$$18$$, $reject$$18$$) {
          return $self$$20$$.$_whereInternal$($attrs$$7$$, $options$$55$$).then(function($collection$$23_models$$10$$) {
            $collection$$23_models$$10$$ = $self$$20$$.$_makeNewCollection$($collection$$23_models$$10$$);
  ...
  $oj$$1$$.$Collection$.prototype.map = function $$oj$$1$$$$Collection$$$map$($iterator$$, $context$$15$$) {
    ...
    this.$_getModels$().forEach(function($model$$27$$) {
      $value$$59$$ = $iterator$$.call($context$$15$$ || this, $model$$27$$);
  ...
  $oj$$1$$.$Collection$.prototype.$sortBy$ = function $$oj$$1$$$$Collection$$$$sortBy$$($iterator$$2$$, $context$$17$$) {
    var $retArr$$2$$ = [], $self$$21$$;
    this.$_throwErrIfVirtual$("sortBy");
    this.$_getModels$().forEach(function($model$$28$$) {
      $retArr$$2$$.push($model$$28$$);
    });
    $self$$21$$ = this;
    $retArr$$2$$.sort(function($a$$86$$, $b$$48$$) {
      var $keyA$$3$$, $keyB$$3$$;
      if ($$$$1$$.isFunction($iterator$$2$$)) {
        return $keyA$$3$$ = $iterator$$2$$.call($context$$17$$ || $self$$21$$, $a$$86$$), $keyB$$3$$ = $iterator$$2$$.call($context$$17$$ || $self$$21$$, $b$$48$$), $oj$$1$$.$Collection$.$_compareKeys$($keyA$$3$$, $keyB$$3$$, $self$$21$$.sortDirection);
      }
      $keyA$$3$$ = $a$$86$$.get($iterator$$2$$);
      $keyB$$3$$ = $b$$48$$.get($iterator$$2$$);
      return $oj$$1$$.$Collection$.$_compareKeys$($keyA$$3$$, $keyB$$3$$, $self$$21$$.sortDirection);
    });
    return $retArr$$2$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$groupBy$ = function $$oj$$1$$$$Collection$$$$groupBy$$($iterator$$3$$, $context$$18$$) {
    ...
    this.$_getModels$().forEach(function($model$$29$$) {
      $groupVal$$ = $$$$1$$.isFunction($iterator$$3$$) ? $iterator$$3$$.call($context$$18$$ || this, $model$$29$$) : $model$$29$$.get($iterator$$3$$);
      void 0 === $retObj$$2$$[$groupVal$$] && ($retObj$$2$$[$groupVal$$] = []);
      $retObj$$2$$[$groupVal$$].push($model$$29$$);
    }, this);
    return $retObj$$2$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$indexBy$ = function $$oj$$1$$$$Collection$$$$indexBy$$($iterator$$4$$, $context$$19$$) {
    ...
    this.$_getModels$().forEach(function($model$$30$$) {
      $index$$69$$ = $$$$1$$.isFunction($iterator$$4$$) ? $iterator$$4$$.call($context$$19$$ || this, $model$$30$$) : $model$$30$$.get($iterator$$4$$);
      $retObj$$3$$[$index$$69$$] = $model$$30$$;
    }, this);
    return $retObj$$3$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.min = function $$oj$$1$$$$Collection$$$min$($iterator$$5$$, $context$$20$$) {
    ...
    this.$_getModels$().forEach(function($model$$31$$, $i$$56$$) {
      1 <= $i$$56$$ && ($currValue$$ = $iterator$$5$$.call($context$$20$$ || this, $model$$31$$), $currValue$$ < $minModelValue$$ && ($minModel$$ = $model$$31$$, $minModelValue$$ = $currValue$$));
    }, this);
    return $minModel$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.max = function $$oj$$1$$$$Collection$$$max$($iterator$$6$$, $context$$21$$) {
    ...
    this.$_getModels$().forEach(function($model$$32$$, $i$$57$$) {
      1 <= $i$$57$$ && ($currValue$$1$$ = $iterator$$6$$.call($context$$21$$ || this, $model$$32$$), $currValue$$1$$ > $maxModelValue$$ && ($maxModel$$ = $model$$32$$, $maxModelValue$$ = $currValue$$1$$));
    }, this);
    return $maxModel$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.filter = function $$oj$$1$$$$Collection$$$filter$($iterator$$7$$, $context$$22$$) {
    ...
    this.$_getModels$().forEach(function($model$$33$$) {
      $iterator$$7$$.call($context$$22$$ || this, $model$$33$$) && $retArr$$3$$.push($model$$33$$);
    });
    return $retArr$$3$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$without$ = function $$oj$$1$$$$Collection$$$$without$$($var_args$$46$$) {
    ...
    for (var $model$$34$$, $i$$58$$ = 0;$i$$58$$ < this.$_getModels$().length;$i$$58$$++) {
      $add$$ = !0;
      $model$$34$$ = this.$_getModel$($i$$58$$);
      for ($j$$2$$ = 0;$j$$2$$ < arguments.length;$j$$2$$ += 1) {
        if ($cid$$4$$ = arguments[$j$$2$$].$GetCid$(), $id$$7$$ = arguments[$j$$2$$].$GetId$(), $model$$34$$.$Match$($id$$7$$, $cid$$4$$)) {
          $add$$ = !1;
          break;
        }
      }
      $add$$ && $retArr$$4$$.push($model$$34$$);
    }
    return $retArr$$4$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$difference$ = function $$oj$$1$$$$Collection$$$$difference$$($var_args$$47$$) {
    ...
    for (var $model$$35$$, $i$$59$$ = 0;$i$$59$$ < this.$_getModels$().length;$i$$59$$++) {
      $add$$1$$ = !0;
      $model$$35$$ = this.$_getModel$($i$$59$$);
      for ($j$$3$$ = 0;$j$$3$$ < arguments.length;$j$$3$$ += 1) {
        for ($k$$3$$ = 0;$k$$3$$ < arguments[$j$$3$$].length;$k$$3$$++) {
          if ($cid$$5$$ = arguments[$j$$3$$][$k$$3$$].$GetCid$(), $id$$8$$ = arguments[$j$$3$$][$k$$3$$].$GetId$(), $model$$35$$.$Match$($id$$8$$, $cid$$5$$)) {
            $add$$1$$ = !1;
            break;
          }
        }
  ...
  $oj$$1$$.$Collection$.prototype.$any$ = function $$oj$$1$$$$Collection$$$$any$$($iterator$$8$$, $context$$23$$) {
    ...
    for (var $model$$36$$, $i$$60$$ = 0;$i$$60$$ < this.$_getModelsLength$();$i$$60$$ += 1) {
      if ($model$$36$$ = this.$_getModel$($i$$60$$), $iterator$$8$$.call($context$$23$$ || this, $model$$36$$)) {
        return!0;
      }
    }
    return!1;
  ...
  $oj$$1$$.$Collection$.prototype.$findWhere$ = function $$oj$$1$$$$Collection$$$$findWhere$$($attrs$$8$$, $options$$56$$) {
    var $arr$$18_deferred$$16$$ = this.$_getDeferred$($options$$56$$), $self$$22$$ = this;
    if (this.$IsVirtual$() || $arr$$18_deferred$$16$$) {
      return this.$_addPromise$(function() {
        return new Promise(function($resolve$$19$$) {
          $self$$22$$.$_whereInternal$($attrs$$8$$, $options$$56$$).then(function($modelList$$1$$) {
  ...
  $oj$$1$$.$Collection$.prototype.$_setInternal$ = function $$oj$$1$$$$Collection$$$$_setInternal$$($i$$63_models$$14$$, $parse$$2_swapped$$, $options$$60$$, $deferred$$19$$) {
    ...
    $modelList$$2$$ = $$$$1$$.isArray($i$$63_models$$14$$) ? $i$$63_models$$14$$ : [$i$$63_models$$14$$];
    if ($deferred$$19$$) {
      return this.$_addPromise$(function() {
        return this.$_deferredSet$($modelList$$2$$, this.$_getModels$(), $options$$60$$, $remove$$2$$, $add$$3$$, $merge$$1$$);
      });
    }
    $parse$$2_swapped$$ = !1;
  ...
  $oj$$1$$.$Collection$.prototype.$_deferredSet$ = function $$oj$$1$$$$Collection$$$$_deferredSet$$($modelList$$3$$, $modelsCopy$$, $options$$61$$, $remove$$3$$, $add$$4$$, $merge$$2$$) {
    var $foundModels$$2$$ = [], $i$$64$$, $self$$23$$ = this;
    return new Promise(function($allResolve$$2$$, $allReject$$2$$) {
      function $doTask$$2$$($index$$70$$) {
        return new Promise(function($resolve$$20$$, $reject$$20$$) {
          $self$$23$$.$_updateModel$($self$$23$$.$_newModel$($modelList$$3$$[$index$$70$$], $options$$61$$, !0), $add$$4$$, $merge$$2$$, !0).then(function($currModel$$1$$) {
      ...
      $currentStep$$2$$.then(function() {
        $oj$$1$$.$Collection$.$_removeAfterSet$($self$$23$$, $modelsCopy$$, $remove$$3$$, $foundModels$$2$$, $options$$61$$);
        $allResolve$$2$$(void 0);
      }, $allReject$$2$$);
    });
  };
  $oj$$1$$.$Collection$.prototype.$_updateModel$ = function $$oj$$1$$$$Collection$$$$_updateModel$$($model$$37$$, $add$$5$$, $merge$$3$$, $deferred$$20$$) {
        ...
        if ($merge$$3$$) {
          ...
          if ($deferred$$21$$) {
            return new Promise(function($resolve$$21$$) {
              $collection$$26$$.$_addInternal$($model$$37$$, $opt$$14$$, !1, !0).then(function() {
                $resolve$$21$$($index$$71$$);
              });
            });
          }
          $collection$$26$$.add($model$$37$$, $opt$$14$$);
        }
      } else {
        if ($add$$5$$) {
          if ($deferred$$21$$) {
    ...
    if ($deferred$$20$$ || this.$IsVirtual$()) {
      ...
      return new Promise(function($resolve$$23$$) {
        $self$$24$$.$_getInternal$($model$$37$$, {silent:!0}, $deferred$$20$$).then(function($found$$3$$) {
          $update$$($self$$24$$, $found$$3$$, !0).then(function($index$$72$$) {
            $resolve$$23$$($index$$72$$);
          });
        });
      });
    }
    var $found$$1$$ = this.$_getInternal$($model$$37$$);
  ...
  $oj$$1$$.$Collection$.prototype.first = function $$oj$$1$$$$Collection$$$first$($n$$12$$, $options$$62$$) {
    ...
    if (1 === $n$$12$$) {
      return $deferred$$22_i$$65_virtual$$2$$ ? this.$_deferredAt$(0, null) : 0 < this.$_getModelsLength$() ? this.$_getModel$(0) : null;
    }
  ...
  $oj$$1$$.$Collection$.prototype.indexOf = function $$oj$$1$$$$Collection$$$indexOf$($model$$39$$, $options$$63$$) {
    var $deferred$$23$$ = this.$_getDeferred$($options$$63$$);
    return this.$IsVirtual$() || $deferred$$23$$ ? this.$_getInternal$($model$$39$$, null, !0).then(function($loc$$1$$) {
      return $loc$$1$$.index;
    }) : this.$_getInternal$($model$$39$$).index;
  };
  $oj$$1$$.$Object$.$exportPrototypeSymbol$("Collection.prototype.indexOf", {indexOf:$oj$$1$$.$Collection$.prototype.indexOf});
  $oj$$1$$.$Collection$.prototype.contains = function $$oj$$1$$$$Collection$$$contains$($model$$40$$, $options$$64$$) {
    var $deferred$$24$$ = this.$_getDeferred$($options$$64$$);
    return this.$IsVirtual$() || $deferred$$24$$ ? this.$_getInternal$($model$$40$$, null, !0).then(function($loc$$2$$) {
      return-1 < $loc$$2$$.index;
    }) : -1 < this.$_getInternal$($model$$40$$).index;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_localIndexOf$ = function $$oj$$1$$$$Collection$$$$_localIndexOf$$($location$$23_model$$41$$) {
    $location$$23_model$$41$$ = this.$_getLocalInternal$($location$$23_model$$41$$);
    return void 0 !== $location$$23_model$$41$$ ? $location$$23_model$$41$$.index : -1;
  };
  $oj$$1$$.$Collection$.prototype.pop = function $$oj$$1$$$$Collection$$$pop$($options$$65$$) {
    ...
    if (this.$IsVirtual$() || $deferred$$25_m$$8$$) {
      var $self$$25$$ = this;
      return this.at(this.$_getLength$() - 1, {deferred:$deferred$$25_m$$8$$}).then(function($model$$42$$) {
        $self$$25$$.remove($model$$42$$, $options$$65$$);
        return $model$$42$$;
      });
    }
  ...
  $oj$$1$$.$Collection$.prototype.lastIndexOf = function $$oj$$1$$$$Collection$$$lastIndexOf$($model$$43$$, $fromIndex$$2$$) {
    var $i$$66$$;
    this.$_throwErrIfVirtual$("lastIndexOf");
    void 0 === $fromIndex$$2$$ && ($fromIndex$$2$$ = 0);
    for ($i$$66$$ = this.$_getLength$() - 1;$i$$66$$ >= $fromIndex$$2$$;$i$$66$$ -= 1) {
      if ($oj$$1$$.$Object$.$__innerEquals$($model$$43$$, this.at($i$$66$$))) {
        return $i$$66$$;
      }
    }
    return-1;
    ...
    for ($i$$67$$ = 0;$i$$67$$ < $q_queries$$.length;$i$$67$$++) {
      ...
      for ($prop$$22$$ in $query$$3$$) {
        if ($query$$3$$.hasOwnProperty($prop$$22$$)) {
          for (var $val$$15$$ = $$$$1$$.isArray($query$$3$$[$prop$$22$$]) ? $query$$3$$[$prop$$22$$] : [$query$$3$$[$prop$$22$$]], $j$$4$$ = 0;$j$$4$$ < $val$$15$$.length;$j$$4$$++) {
  ...
  $oj$$1$$.$Collection$.prototype.$GetCollectionFetchUrl$ = function $$oj$$1$$$$Collection$$$$GetCollectionFetchUrl$$($attrs$$10_comparator$$6_options$$69_queryString$$) {
    ...
    if (this.$IsVirtual$()) {
      var $all_sortDirStr$$ = $attrs$$10_comparator$$6_options$$69_queryString$$.all, $i$$69_limit$$4_totalResults$$3$$ = null;
      $i$$69_limit$$4_totalResults$$3$$ = $all_sortDirStr$$ ? ($i$$69_limit$$4_totalResults$$3$$ = this.totalResults) ? $i$$69_limit$$4_totalResults$$3$$ : this.$_getFetchSize$($attrs$$10_comparator$$6_options$$69_queryString$$) : this.$_getFetchSize$($attrs$$10_comparator$$6_options$$69_queryString$$);
      $url$$19$$ = $url$$19$$ && -1 < $url$$19$$.indexOf("?") ? $url$$19$$ + "\x26" : $url$$19$$ + "?";
      $url$$19$$ += "limit\x3d" + $i$$69_limit$$4_totalResults$$3$$;
      $all_sortDirStr$$ || ($oj$$1$$.$Collection$.$_defined$($attrs$$10_comparator$$6_options$$69_queryString$$.startIndex) && ($url$$19$$ += "\x26offset\x3d" + $attrs$$10_comparator$$6_options$$69_queryString$$.startIndex), $attrs$$10_comparator$$6_options$$69_queryString$$.startID && ($url$$19$$ += "\x26fromID\x3d" + $attrs$$10_comparator$$6_options$$69_queryString$$.startID), $attrs$$10_comparator$$6_options$$69_queryString$$.since && ($url$$19$$ += "\x26since\x3d" + $attrs$$10_comparator$$6_options$$69_queryString$$.since), 
      $attrs$$10_comparator$$6_options$$69_queryString$$.until && ($url$$19$$ += "\x26until\x3d" + $attrs$$10_comparator$$6_options$$69_queryString$$.until));
      $attrs$$10_comparator$$6_options$$69_queryString$$.query && ($attrs$$10_comparator$$6_options$$69_queryString$$ = $oj$$1$$.$Collection$.$_getQueryString$($attrs$$10_comparator$$6_options$$69_queryString$$.query)) && 0 < $attrs$$10_comparator$$6_options$$69_queryString$$.length && ($url$$19$$ += "\x26q\x3d" + $attrs$$10_comparator$$6_options$$69_queryString$$);
      if (($attrs$$10_comparator$$6_options$$69_queryString$$ = this.comparator) && $oj$$1$$.$StringUtils$.$isString$($attrs$$10_comparator$$6_options$$69_queryString$$)) {
        for ($attrs$$10_comparator$$6_options$$69_queryString$$ = this.$_getSortAttrs$($attrs$$10_comparator$$6_options$$69_queryString$$), $all_sortDirStr$$ = this.$_getSortDirStr$(), $i$$69_limit$$4_totalResults$$3$$ = 0;$i$$69_limit$$4_totalResults$$3$$ < $attrs$$10_comparator$$6_options$$69_queryString$$.length;$i$$69_limit$$4_totalResults$$3$$++) {
          $url$$19$$ = 0 === $i$$69_limit$$4_totalResults$$3$$ ? $url$$19$$ + ("\x26orderBy\x3d" + $attrs$$10_comparator$$6_options$$69_queryString$$[$i$$69_limit$$4_totalResults$$3$$] + ":" + $all_sortDirStr$$) : $url$$19$$ + ("," + $attrs$$10_comparator$$6_options$$69_queryString$$[$i$$69_limit$$4_totalResults$$3$$] + ":" + $all_sortDirStr$$);
        }
      }
  ...
  $oj$$1$$.$Model$._init = function $$oj$$1$$$$Model$$_init$($model$$44$$, $attributes$$2$$, $options$$72$$, $parse$$4_properties$$5$$) {
    var $prop$$24$$ = null, $attrCopy$$;
    if (!$oj$$1$$.$Model$.$_justExtending$) {
      $model$$44$$.Init();
      $oj$$1$$.$Events$.$Mixin$($model$$44$$);
      $model$$44$$.$_clearChanged$();
      $model$$44$$.$previousAttrs$ = {};
      $model$$44$$.$nestedSet$ = !1;
      $model$$44$$.index = -1;
      $options$$72$$ = $options$$72$$ || {};
      $model$$44$$.attributes = {};
      $model$$44$$.defaults && !$options$$72$$.$ignoreDefaults$ && ($model$$44$$.attributes = $oj$$1$$.$Model$.$_cloneAttributes$($$$$1$$.isFunction($model$$44$$.defaults) ? $model$$44$$.defaults() : $model$$44$$.defaults, null));
      for ($prop$$24$$ in $parse$$4_properties$$5$$) {
        $parse$$4_properties$$5$$.hasOwnProperty($prop$$24$$) && ($model$$44$$[$prop$$24$$] = $parse$$4_properties$$5$$[$prop$$24$$]);
      }
      if ($attributes$$2$$) {
        if ($parse$$4_properties$$5$$ = $options$$72$$.parse, $$$$1$$.isFunction($parse$$4_properties$$5$$) && ($model$$44$$.parse = $parse$$4_properties$$5$$), $attrCopy$$ = $oj$$1$$.$Model$.$_cloneAttributes$($attributes$$2$$, $model$$44$$.attributes), $attrCopy$$ = $parse$$4_properties$$5$$ ? $model$$44$$.parse($attrCopy$$) : $attrCopy$$, null == $attrCopy$$ || void 0 === $attrCopy$$) {
          $model$$44$$.attributes = {};
        } else {
          for ($prop$$24$$ in $attrCopy$$) {
            $attrCopy$$.hasOwnProperty($prop$$24$$) && $model$$44$$.$_setProp$($prop$$24$$, $attrCopy$$[$prop$$24$$], !1, !1, $options$$72$$);
          }
        }
      }
      $model$$44$$.$SetCid$();
      $model$$44$$.$SetCollection$($options$$72$$.collection);
      $options$$72$$.customURL && ($model$$44$$.customURL = $options$$72$$.customURL);
      $options$$72$$.url && ($model$$44$$.url = $options$$72$$.url);
      $options$$72$$.urlRoot && ($model$$44$$.urlRoot = $options$$72$$.urlRoot);
      $model$$44$$.initialize && $model$$44$$.initialize($attributes$$2$$, $options$$72$$);
      $model$$44$$.$SetupId$();
    }
  };
  ...
  $oj$$1$$.$Model$.prototype.$SetNext$ = function $$oj$$1$$$$Model$$$$SetNext$$($model$$45$$) {
    this.$nextModel$ = $model$$45$$;
  };
  $oj$$1$$.$Model$.prototype.$SetPrevious$ = function $$oj$$1$$$$Model$$$$SetPrevious$$($model$$46$$) {
    var $retVal$$3$$ = this.$previousModel$;
    this.$previousModel$ = $model$$46$$;
    return $retVal$$3$$;
  };
  $oj$$1$$.$Model$.prototype.$Merge$ = function $$oj$$1$$$$Model$$$$Merge$$($model$$47$$, $comparator$$7$$, $silent$$12$$) {
    var $prop$$26$$, $needSort$$1$$ = !1, $isStringComparator$$ = $oj$$1$$.$StringUtils$.$isString$($comparator$$7$$), $valueChange$$, $changes$$ = !1;
    for ($prop$$26$$ in $model$$47$$.attributes) {
      $model$$47$$.attributes.hasOwnProperty($prop$$26$$) && ($valueChange$$ = this.attributes[$prop$$26$$] != $model$$47$$.attributes[$prop$$26$$], $isStringComparator$$ ? $prop$$26$$ === $comparator$$7$$ && $valueChange$$ && ($needSort$$1$$ = !0) : $valueChange$$ && ($needSort$$1$$ = !0), $valueChange$$ && ($changes$$ = !0, this.attributes[$prop$$26$$] = $model$$47$$.attributes[$prop$$26$$], this.$_addChange$($prop$$26$$, $model$$47$$.attributes[$prop$$26$$]), this.$_fireAttrChange$($prop$$26$$, 
  ...
  $oj$$1$$.$Model$.prototype.clone = function $$oj$$1$$$$Model$$$clone$() {
    var $c$$25$$ = new this.constructor, $prop$$33$$;
    for ($prop$$33$$ in this) {
      this.hasOwnProperty($prop$$33$$) && this[$prop$$33$$] !== this.attributes && ($c$$25$$[$prop$$33$$] = this[$prop$$33$$]);
    }
    $c$$25$$.attributes = $oj$$1$$.$Model$.$_cloneAttributes$(this.attributes, null);
    delete $c$$25$$.cid;
    $c$$25$$.$SetCid$();
    $c$$25$$.$SetupId$();
    return $c$$25$$;
  ...
  $oj$$1$$.$Model$.prototype.set = function $$oj$$1$$$$Model$$$set$($property$$6$$, $value$$65$$, $options$$79$$) {
    var $opts$$5$$ = $options$$79$$ || {}, $ignoreLastArg$$ = !1, $i$$70_prop$$34$$, $valid$$ = !0;
    if (arguments && 0 < arguments.length) {
      if (1 < arguments.length && arguments[arguments.length - 1] && ($ignoreLastArg$$ = !0, $opts$$5$$ = arguments[arguments.length - 1] || {}), $oj$$1$$.$Model$.$_hasProperties$($property$$6$$)) {
        if ($opts$$5$$.unset) {
          for ($i$$70_prop$$34$$ in $property$$6$$) {
            $property$$6$$.hasOwnProperty($i$$70_prop$$34$$) && this.$_unsetInternal$($i$$70_prop$$34$$, null, !1);
          }
        } else {
          this.$_setProp$($property$$6$$, null, !0, !0, $opts$$5$$) || ($valid$$ = !1);
        }
      } else {
        for ($i$$70_prop$$34$$ = 0;$i$$70_prop$$34$$ < arguments.length;$i$$70_prop$$34$$ += 2) {
          if (void 0 !== arguments[$i$$70_prop$$34$$] || $i$$70_prop$$34$$ < arguments.length - 1 || !$ignoreLastArg$$ && $i$$70_prop$$34$$ === arguments.length - 1) {
            $opts$$5$$.unset ? this.$_unsetInternal$(arguments[$i$$70_prop$$34$$], null, !1) : this.$_setProp$(arguments[$i$$70_prop$$34$$], arguments[$i$$70_prop$$34$$ + 1], !1, !1, $opts$$5$$) || ($valid$$ = !1);
          }
        }
      }
    }
  ...
  $oj$$1$$.$Model$.prototype.fetch = function $$oj$$1$$$$Model$$$fetch$($options$$82$$) {
    ...
    var $success$$11$$ = $options$$82$$.success, $userErr$$ = $options$$82$$.error, $self$$26$$ = this, $opts$$6$$;
    $opts$$6$$ = $oj$$1$$.$Model$.$_copyOptions$($options$$82$$);
    $opts$$6$$.error = function $$opts$$6$$$error$($xhr$$10$$, $status$$9$$, $err$$3$$) {
      $oj$$1$$.$Model$.$_triggerError$($self$$26$$, !1, $options$$82$$, $status$$9$$, $err$$3$$, $xhr$$10$$);
      $userErr$$ && $userErr$$.apply($self$$26$$, arguments);
    };
    $opts$$6$$.success = function $$opts$$6$$$success$($response$$10$$) {
      $opts$$6$$.xhr && ($options$$82$$.xhr = $opts$$6$$.xhr);
      $oj$$1$$.$Model$.$_fireSyncEvent$($self$$26$$, $response$$10$$, $opts$$6$$);
      $$$$1$$.isFunction($self$$26$$.parse) && $self$$26$$.set($self$$26$$.parse($response$$10$$), $opts$$6$$);
      $success$$11$$ && $success$$11$$.call($self$$26$$, this, $response$$10$$, $options$$82$$);
    };
  ...
  $oj$$1$$.$Model$.prototype.$pick$ = function $$oj$$1$$$$Model$$$$pick$$($keys$$3$$) {
    var $keyArr$$1$$ = [], $i$$72$$, $retObj$$6$$ = {};
    if ($keys$$3$$ instanceof Array) {
      $keyArr$$1$$ = $keys$$3$$;
    } else {
      for ($i$$72$$ = 0;$i$$72$$ < arguments.length;$i$$72$$++) {
        $keyArr$$1$$.push(arguments[$i$$72$$]);
      }
    }
    for ($i$$72$$ = 0;$i$$72$$ < $keyArr$$1$$.length;$i$$72$$++) {
      this.attributes.hasOwnProperty($keyArr$$1$$[$i$$72$$]) && ($retObj$$6$$[$keyArr$$1$$[$i$$72$$]] = this.get($keyArr$$1$$[$i$$72$$]));
    }
    return $retObj$$6$$;
  };
  ...
  $oj$$1$$.$Model$.$_processArgs$ = function $$oj$$1$$$$Model$$$_processArgs$$($args$$16$$) {
    var $ignoreLastArg$$1$$ = !1, $options$$86$$ = {}, $i$$73_prop$$40$$, $attributes$$5$$ = {};
    if ($args$$16$$ && 0 < $args$$16$$.length) {
      1 < $args$$16$$.length && $args$$16$$[$args$$16$$.length - 1] && $oj$$1$$.$Model$.$_hasProperties$($args$$16$$[$args$$16$$.length - 1]) && ($ignoreLastArg$$1$$ = !0, $options$$86$$ = $args$$16$$[$args$$16$$.length - 1] || {});
      if (null == $args$$16$$[0]) {
        return{attributes:null, options:$options$$86$$};
      }
      if ($oj$$1$$.$Model$.$_hasProperties$($args$$16$$[0]) || $oj$$1$$.$Object$.$isEmpty$($args$$16$$[0])) {
        for ($i$$73_prop$$40$$ in $args$$16$$[0]) {
          $args$$16$$[0].hasOwnProperty($i$$73_prop$$40$$) && ($attributes$$5$$[$i$$73_prop$$40$$] = $args$$16$$[0][$i$$73_prop$$40$$]);
        }
      } else {
        for ($i$$73_prop$$40$$ = 0;$i$$73_prop$$40$$ < $args$$16$$.length;$i$$73_prop$$40$$ += 2) {
          if (void 0 !== $args$$16$$[$i$$73_prop$$40$$] || $i$$73_prop$$40$$ < $args$$16$$.length - 1 || !$ignoreLastArg$$1$$ && $i$$73_prop$$40$$ === $args$$16$$.length - 1) {
            $attributes$$5$$[$args$$16$$[$i$$73_prop$$40$$]] = $args$$16$$[$i$$73_prop$$40$$ + 1];
          }
        }
      }
    }
  ...
  $oj$$1$$.$Model$.$_triggerError$ = function $$oj$$1$$$$Model$$$_triggerError$$($self$$27$$, $silent$$18$$, $options$$88$$, $status$$10$$, $err$$4$$, $xhr$$11$$) {
    $options$$88$$ = $options$$88$$ || {};
    $options$$88$$.textStatus = $status$$10$$;
    $options$$88$$.errorThrown = $err$$4$$;
    $self$$27$$.$TriggerInternal$($silent$$18$$, $oj$$1$$.$Events$.$EventType$.ERROR, $self$$27$$, $xhr$$11$$, $options$$88$$);
  };
  $oj$$1$$.$Model$.prototype.save = function $$oj$$1$$$$Model$$$save$($attributes$$6$$, $options$$89$$) {
    var $argResults_forceNew$$, $success$$12$$, $callback$$74$$, $self$$28$$, $userErr$$1$$, $patch$$;
    ...
    $patch$$ = $opts$$7$$.patch;
    $opts$$7$$.error = function $$opts$$7$$$error$($xhr$$12$$, $status$$11$$, $err$$5$$) {
      $oj$$1$$.$Model$.$_triggerError$($self$$28$$, !1, $options$$89$$, $status$$11$$, $err$$5$$, $xhr$$12$$);
      $userErr$$1$$ && $userErr$$1$$.apply($self$$28$$, arguments);
    };
    ...
    if (!$argResults_forceNew$$ && !this.$isNew$()) {
      return $success$$12$$ = $opts$$7$$.success, $opts$$7$$.success = function $$opts$$7$$$success$($resp$$5$$) {
        ...
        $resp$$5$$ && ($attrs$$13$$ = $$$$1$$.isFunction($self$$28$$.parse) ? $self$$28$$.parse($resp$$5$$) : $resp$$5$$, $self$$28$$.attributes = $$$$1$$.extend(!0, $self$$28$$.attributes, $attrs$$13$$), $self$$28$$.$SetupId$());
        $oj$$1$$.$Model$.$_fireSyncEvent$($self$$28$$, $resp$$5$$, $opts$$7$$);
        $opts$$7$$.wait && $self$$28$$.set($attrArgs$$);
        $success$$12$$ && $success$$12$$.call($oj$$1$$.$Model$.$GetContext$($opts$$7$$, $self$$28$$), $self$$28$$, $resp$$5$$, $options$$89$$);
        $self$$28$$.$_clearChanged$();
    ...
    $callback$$74$$ = $oj$$1$$.$Model$.$_getSuccess$($opts$$7$$);
    $opts$$7$$.success = function $$opts$$7$$$success$($resp$$6$$) {
      var $attrs$$14$$;
      $opts$$7$$.xhr && ($options$$89$$.xhr = $opts$$7$$.xhr);
      if ($resp$$6$$) {
        $attrs$$14$$ = $$$$1$$.isFunction($self$$28$$.parse) ? $self$$28$$.parse($resp$$6$$) : $resp$$6$$;
        if (!$self$$28$$.$_checkValid$($attrs$$14$$, $opts$$7$$, !0)) {
          return;
        }
        $self$$28$$.attributes = $$$$1$$.extend(!0, $self$$28$$.attributes, $attrs$$14$$);
        $self$$28$$.$SetupId$();
      }
      $opts$$7$$.wait && $self$$28$$.set($attrArgs$$);
      $oj$$1$$.$Model$.$_fireSyncEvent$($self$$28$$, $resp$$6$$, $opts$$7$$);
      $callback$$74$$ && $callback$$74$$.call($oj$$1$$.$Model$.$GetContext$($opts$$7$$, $self$$28$$), $self$$28$$, $resp$$6$$, $options$$89$$);
      $self$$28$$.$_clearChanged$();
    };
  ...
  $oj$$1$$.$Model$.prototype.$_hasAttrs$ = function $$oj$$1$$$$Model$$$$_hasAttrs$$($attrs$$16$$) {
    for (var $prop$$43$$ in $attrs$$16$$) {
      if ($attrs$$16$$.hasOwnProperty($prop$$43$$)) {
        ...
        for (var $val$$18$$ = $$$$1$$.isArray($attrs$$16$$[$prop$$43$$]) ? $attrs$$16$$[$prop$$43$$] : [$attrs$$16$$[$prop$$43$$]], $i$$74$$ = 0;$i$$74$$ < $val$$18$$.length;$i$$74$$++) {
          if ($oj$$1$$.$Model$.$IsComplexValue$($val$$18$$[$i$$74$$])) {
            var $comparator$$8$$ = $val$$18$$[$i$$74$$].comparator, $value$$66$$ = $val$$18$$[$i$$74$$].value;
  ...
  $oj$$1$$.$Model$.prototype.matches = function $$oj$$1$$$$Model$$$matches$($JSCompiler_inline_result$$4_attrs$$17$$) {
    a: {
      for (var $prop$$inline_366$$ in $JSCompiler_inline_result$$4_attrs$$17$$) {
        if (this.get($prop$$inline_366$$) !== $JSCompiler_inline_result$$4_attrs$$17$$[$prop$$inline_366$$]) {
  ...
  $oj$$1$$.$Model$.prototype.$Contains$ = function $$oj$$1$$$$Model$$$$Contains$$($attrList_attrs$$18$$) {
    ...
    var $i$$75$$;
    for ($i$$75$$ = 0;$i$$75$$ < $attrList_attrs$$18$$.length;$i$$75$$++) {
      if (this.$_hasAttrs$($attrList_attrs$$18$$[$i$$75$$])) {
        return!0;
      }
    }
    return!1;
  ...
  $oj$$1$$.$Model$.$GetContext$ = function $$oj$$1$$$$Model$$$GetContext$$($options$$91$$, $model$$49$$) {
    return void 0 !== $options$$91$$ && void 0 !== $options$$91$$.context ? $options$$91$$.context : $model$$49$$;
  };
  ...
  $oj$$1$$.$Model$.prototype.destroy = function $$oj$$1$$$$Model$$$destroy$($options$$92$$) {
    ...
    var $isWait$$ = $options$$92$$.wait, $callback$$75$$, $userErr$$2$$ = $options$$92$$.error, $self$$29$$ = this, $xhr$$14$$, $opts$$8$$;
    $opts$$8$$ = $oj$$1$$.$Model$.$_copyOptions$($options$$92$$);
    $callback$$75$$ = $oj$$1$$.$Model$.$_getSuccess$($opts$$8$$);
    var $collection$$28$$ = this.$GetCollection$();
    $opts$$8$$.success = function $$opts$$8$$$success$($data$$39$$) {
      $opts$$8$$.xhr && ($options$$92$$.xhr = $opts$$8$$.xhr);
      $isWait$$ && $self$$29$$.$_fireDestroy$();
      if ($collection$$28$$) {
      ...
      $oj$$1$$.$Model$.$_fireSyncEvent$($self$$29$$, $data$$39$$, $opts$$8$$);
      $callback$$75$$ && $callback$$75$$.call($oj$$1$$.$Model$.$GetContext$($opts$$8$$, $self$$29$$), $self$$29$$, $data$$39$$, $options$$92$$);
    };
    $opts$$8$$.error = function $$opts$$8$$$error$($xhr$$16$$, $status$$14$$, $err$$6$$) {
      $self$$29$$.$TriggerInternal$(!1, $oj$$1$$.$Events$.$EventType$.ERROR, $self$$29$$, $xhr$$16$$, $options$$92$$);
      $userErr$$2$$ && $userErr$$2$$.apply($self$$29$$, arguments);
    };
    if (!this.$isNew$()) {
      return $xhr$$14$$ = $oj$$1$$.$Model$.$_internalSync$("delete", this, $opts$$8$$), $isWait$$ || this.$_fireDestroy$(), $xhr$$14$$;
    }
    $isWait$$ || this.$_fireDestroy$();
    $callback$$75$$ && $callback$$75$$.call($oj$$1$$.$Model$.$GetContext$($opts$$8$$, $self$$29$$), $self$$29$$, null, $options$$92$$);
    return!1;
  };
  $oj$$1$$.$Object$.$exportPrototypeSymbol$("Model.prototype.destroy", {destroy:$oj$$1$$.$Model$.prototype.destroy});
  $oj$$1$$.$Model$.prototype.$_fireRequest$ = function $$oj$$1$$$$Model$$$$_fireRequest$$($model$$50$$, $xhr$$17$$, $options$$93$$, $silent$$19$$) {
    this.$TriggerInternal$($silent$$19$$, $oj$$1$$.$Events$.$EventType$.REQUEST, $model$$50$$, $xhr$$17$$, $options$$93$$);
  };
  ...
  $oj$$1$$.$Model$.$_fireSyncEvent$ = function $$oj$$1$$$$Model$$$_fireSyncEvent$$($model$$51$$, $resp$$7$$, $options$$94$$) {
    $model$$51$$.$TriggerInternal$(!1, $oj$$1$$.$Events$.$EventType$.SYNC, $model$$51$$, $resp$$7$$, $options$$94$$);
  };
  $oj$$1$$.$Model$.prototype.toJSON = function $$oj$$1$$$$Model$$$toJSON$() {
    var $retObj$$8$$ = {}, $prop$$46$$;
    for ($prop$$46$$ in this.attributes) {
      this.attributes.hasOwnProperty($prop$$46$$) && ($$$$1$$.isArray(this.attributes[$prop$$46$$]) ? $retObj$$8$$[$prop$$46$$] = this.attributes[$prop$$46$$].slice(0) : $retObj$$8$$[$prop$$46$$] = this.attributes[$prop$$46$$]);
    }
    return $retObj$$8$$;
  };
  ...
  $oj$$1$$.$Model$.prototype.sync = function $$oj$$1$$$$Model$$$sync$($method$$3$$, $model$$52$$, $options$$95$$) {
    return window.oj.sync($method$$3$$, $model$$52$$, $options$$95$$);
  };
  $oj$$1$$.$Model$.$_internalSync$ = function $$oj$$1$$$$Model$$$_internalSync$$($method$$4$$, $model$$53$$, $options$$96$$) {
    $options$$96$$ = $options$$96$$ || {};
    $model$$53$$.oauth && ($options$$96$$.oauthHeader = $model$$53$$.oauth.getHeader());
    !$options$$96$$.dataType && $model$$53$$.dataType && ($options$$96$$.dataType = $model$$53$$.dataType);
    !$options$$96$$.jsonpCallback && $model$$53$$.jsonpCallback && ($options$$96$$.jsonpCallback = $model$$53$$.jsonpCallback);
    if ("create" === $method$$4$$ || "patch" === $method$$4$$ || "update" === $method$$4$$) {
      $options$$96$$.$parsedData$ = $model$$53$$.parseSave.call($model$$53$$, "patch" === $method$$4$$ ? $options$$96$$.attrs : $options$$96$$.saveAttrs);
    }
    var $recordId_urlOpt$$ = null;
    $model$$53$$ instanceof $oj$$1$$.$Model$ && ($recordId_urlOpt$$ = $model$$53$$.$GetId$());
    var $newOpt$$ = {};
    if ($options$$96$$) {
    ...
    $recordId_urlOpt$$ = $oj$$1$$.$Model$.$SetCustomURLOptions$($recordId_urlOpt$$, $model$$53$$, $options$$96$$);
    for ($prop$$47$$ in $recordId_urlOpt$$) {
      $newOpt$$[$prop$$47$$] = $recordId_urlOpt$$[$prop$$47$$];
    }
    $options$$96$$.xhr = $model$$53$$.sync($method$$4$$, $model$$53$$, $newOpt$$);
  ...
  $oj$$1$$.$sync$ = function $$oj$$1$$$$sync$$($method$$5_url$$20$$, $model$$54$$, $options$$98$$) {
    function $_fireAndReturn$$($xhr$$18$$) {
      $model$$54$$.$_fireRequest$($model$$54$$, $xhr$$18$$, $options$$98$$, $options$$98$$.silent);
      return $xhr$$18$$;
    }
    $options$$98$$ = $options$$98$$ || {};
    var $customURL$$1_restService$$, $success$$13$$ = $options$$98$$.success, $error$$11$$ = $options$$98$$.error;
    $customURL$$1_restService$$ = $model$$54$$.customURL;
    if ("create" === $method$$5_url$$20$$.valueOf()) {
      return $method$$5_url$$20$$ = ($method$$5_url$$20$$ = $model$$54$$.$_saveUrl$()) ? $method$$5_url$$20$$ : $oj$$1$$.$Model$.$GetPropValue$($model$$54$$, "url"), $customURL$$1_restService$$ = new $oj$$1$$.$RestImpl$($method$$5_url$$20$$, $customURL$$1_restService$$), $_fireAndReturn$$($customURL$$1_restService$$.$addRecord$($options$$98$$.$parsedData$, $error$$11$$, $options$$98$$, $model$$54$$));
    }
    if ("read" === $method$$5_url$$20$$.valueOf()) {
      if ($model$$54$$ instanceof $oj$$1$$.$Model$) {
        return $method$$5_url$$20$$ = $options$$98$$.url ? $options$$98$$.url : $oj$$1$$.$Model$.$GetPropValue$($model$$54$$, "url"), $customURL$$1_restService$$ = new $oj$$1$$.$RestImpl$($method$$5_url$$20$$, $customURL$$1_restService$$), $_fireAndReturn$$($customURL$$1_restService$$.$getRecord$($success$$13$$, $error$$11$$, $model$$54$$.$GetId$(), $options$$98$$, $oj$$1$$.$Model$.$GetContext$($options$$98$$, $model$$54$$)));
      }
      $method$$5_url$$20$$ = $model$$54$$.$GetCollectionFetchUrl$($options$$98$$);
      $customURL$$1_restService$$ = new $oj$$1$$.$RestImpl$($method$$5_url$$20$$, $customURL$$1_restService$$);
      return $_fireAndReturn$$($customURL$$1_restService$$.$getRecords$($success$$13$$, $error$$11$$, $options$$98$$, $model$$54$$));
    }
    $customURL$$1_restService$$ = new $oj$$1$$.$RestImpl$($oj$$1$$.$Model$.$GetPropValue$($model$$54$$, "url"), $customURL$$1_restService$$);
    var $recordId$$1$$ = null;
    $model$$54$$ instanceof $oj$$1$$.$Model$ && ($recordId$$1$$ = $model$$54$$.$GetId$());
    return "update" === $method$$5_url$$20$$.valueOf() ? $_fireAndReturn$$($customURL$$1_restService$$.$updateRecord$($success$$13$$, $recordId$$1$$, $options$$98$$.$parsedData$, $error$$11$$, $options$$98$$, $model$$54$$, !1)) : "patch" === $method$$5_url$$20$$.valueOf() ? $_fireAndReturn$$($customURL$$1_restService$$.$updateRecord$($success$$13$$, $recordId$$1$$, $options$$98$$.$parsedData$, $error$$11$$, $options$$98$$, $model$$54$$, !0)) : "delete" === $method$$5_url$$20$$.valueOf() ? $_fireAndReturn$$($customURL$$1_restService$$.$deleteRecord$($recordId$$1$$, 
    $error$$11$$, $options$$98$$, $model$$54$$)) : null;
  };
  ...
  $oj$$1$$.$OAuth$.prototype.$clientCredentialGrant$ = function $$oj$$1$$$$OAuth$$$$clientCredentialGrant$$() {
    ...
    $$$$1$$.ajax({type:"POST", async:!1, url:this.$accessTokenRequest$.bearer_url, data:"grant_type\x3dclient_credentials", headers:$headers$$1$$, success:function($data$$40$$) {
      $oj$$1$$.$OAuth$.$_initAccessToken$($self$$30$$.$accessTokenResponse$, $data$$40$$);
